! function(i) { "use strict"; "function" == typeof define && define.amd ? define(["jquery"], i) : "undefined" != typeof exports ? module.exports = i(require("jquery")) : i(jQuery) }((function(i) {
    ...
    }, e.prototype.getNavTarget = function() { var t = this.options.asNavFor; return t && null !== t && (t = i(t).not(this.$slider)), t }, e.prototype.asNavFor = function(e) {
...
function(a) { "function" == typeof define && define.amd ? define(["jquery"], a) : a("object" == typeof exports ? require("jquery") : window.jQuery || window.Zepto) }((function(a) {
    ...
    t.prototype = {
        ...
        open: function(c) {
            ...
            if (!1 === c.isObj) {
                ...
                for (e = 0; e < h.length; e++)
                    if ((g = h[e]).parsed && (g = g.el[0]), g === c.el[0]) { b.index = e; break }
        ...
        appendContent: function(a, c) { b.content = a, a ? b.st.showCloseBtn && b.st.closeBtnInside && !0 === b.currTemplate[c] ? b.content.find(".mfp-close").length || b.content.append(z()) : b.content = a : b.content = "", y("BeforeAppend"), b.container.addClass("mfp-" + c + "-holder"), b.contentContainer.append(b.content) },
        parseEl: function(c) {
            var d, e = b.items[c];
        ...
        _parseMarkup: function(b, c, d) {
            var e;
            d.data && (c = a.extend(d.data, c)), y(l, [b, c, d]), a.each(c, (function(c, d) { if (void 0 === d || !1 === d) return !0; if ((e = c.split("_")).length > 1) { var f = b.find(p + "-" + e[0]); if (f.length > 0) { var g = e[1]; "replaceWith" === g ? f[0] !== d[0] && f.replaceWith(d) : "img" === g ? f.is("img") ? f.attr("src", d) : f.replaceWith(a("<img>").attr("src", d).attr("class", f.attr("class"))) : f.attr(e[1], d) } } else b.find(p + "-" + c).html(d) }))
        },
    ...
    a.magnificPopup.registerModule("zoom", {
        ...
        proto: {
                ...
                if (c.enabled && b.supportsTransition) {
                    ...
                    w("BuildControls" + d, (function() {
                        if (b._allowZoom()) {
                            ...
                            (f = j(a)).css(b._getOffset()), b.wrap.append(f), e = setTimeout((function() { f.css(b._getOffset(!0)), e = setTimeout((function() { k(), setTimeout((function() { f.remove(), a = f = null, y("ZoomAnimationEnded") }), 16) }), g) }), 16)
                        }
                    })), w(i + d, (function() {
                        if (b._allowZoom()) {
            ...
            _getItemToZoom: function() { return !!b.currItem.hasSize && b.currItem.img },
    ...
    a.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                })), w(n + e, (function() { b._preloadTimeout && clearTimeout(b._preloadTimeout), b._preloadTimeout = setTimeout((function() { b.preloadNearbyImages(), b._preloadTimeout = null }), 16) })), void w(h + e, (function() { d.off(e), b.wrap.off("click" + e), b.arrowRight = b.arrowLeft = null })))
            },
        ...
        proto: {
            initRetina: function() {
                if (window.devicePixelRatio > 1) {
                    var a = b.st.retina,
                        c = a.ratio;
                    (c = isNaN(c) ? c() : c) > 1 && (w("ImageHasSize." + U, (function(a, b) { b.img.css({ "max-width": b.img[0].naturalWidth / c, width: "100%" }) })), w("ElementParse." + U, (function(b, d) { d.src = a.replaceSrc(d, c) })))
                }
            }
        }
    }), A()
...
function mm_destroy(_parent, mmpanel) { mmpanel.remember_state || (_parent.find(".mmpanel").toggleClass("mmsubopened mmcurrent mmopened", !1).addClass("mmhidden"), _parent.find("#mm0").addClass("mmopened").addClass("mmcurrent").removeClass("mmhidden")), _parent.toggleClass("mmhide mmitemopen", !1).hide(), $("body").removeClass("mm-open") }

function get_mm_parent() { return '<div class="mmpanels"></div>' }

function get_mm_block() { return '<div class="mmpanel mmhidden">' }

function getButtonBack(value, _default) { return '<li><a href="#" data-target="#" class="mm-prev-level">' + (value = null == value ? _default : value) + "</a></li>" }

function getButtonClose(value, _default) { return '<li class="mm-close-parent"><a href="#close" data-target="#close" class="mm-close">' + (value = null == value ? _default : value) + "</a></li>" }
...
$("body").append(getFullscreenBg()), $.fn.initMM = function() {
        var mmpanel = {
            ...
            show_button_in_mobile: function($button) {
                var _this = this;
                _this.mm_mobile_button && (window.innerWidth > _this.mm_breakpoint ? $button.hide() : $button.show(), $(window).resize((function() { window.innerWidth > _this.mm_breakpoint ? $button.hide() : $button.show() })))
            }
        };
    ...
    }, $.fn.mm_handler = function(mmpanel) { $(this).click((function(e) { e.preventDefault(), mmpanel.$mobilemenu.openmm() })), 0 != mmpanel.second_button && $(mmpanel.second_button).click((function(e) { e.preventDefault(), mmpanel.$mobilemenu.openmm() })) }, $.fn.parse_mm = function(mmpanel) {
        var $ul, $mm_curent = $(this).clone(),
            ...
            _this = !1,
            $btnBack = !1;
        $(this).empty(), $mm_curent.find("a").each((function() { _this = $(this), ($ul = _this.parent().find("ul").first()).length && (count++, $ul.prepend("<li></li>").find("li").first().append(_this.clone().addClass("mm-original-link")), _this.attr("href", "#mm" + count).attr("data-target", "#mm" + count).addClass("mm-next-level")) })), $mm_curent.find("ul").each((function(index) { $btnBack = !1, $mm_block = $(get_mm_block()).attr("id", "mm" + index).append($(this)), 0 == index ? ($mm_block.addClass("mmopened").addClass("mmcurrent").removeClass("mmhidden"), $btnBack = getButtonClose($mm_curent.find(".mm-closebtn").html(), mmpanel.mm_close_button), $mm_block.find("ul").first().prepend($btnBack)) : ($btnBack = getButtonBack($mm_curent.find(".mm-backbtn").html(), mmpanel.mm_back_button), $mm_block.find("ul").first().prepend($btnBack)), $mm_new.append($mm_block) })), $(this).append($mm_new)
        ...
        _parent.find("a").each((function() {
            $(this).click((function(e) {
                var _this = $(this),
                    $currobj = !1,
                    lv = "";
                return _this.hasClass("mm-next-level") ? (e.preventDefault(), lv = _this.attr("href"), ($currobj = _parent.find(".mmcurrent")).addClass("mmsubopened").removeClass("mmcurrent"), _parent.find(lv).removeClass("mmhidden"), setTimeout((function() { _parent.find(lv).scrollTop(0).addClass("mmcurrent").addClass("mmopened") }), 0), setTimeout((function() { $currobj.addClass("mmhidden") }), delay_tab), !1) : _this.hasClass("mm-prev-level") ? (e.preventDefault(), lv = _this.attr("href"), ($currobj = _parent.find(".mmcurrent")).removeClass("mmcurrent").removeClass("mmopened"), _parent.find(".mmsubopened").last().removeClass("mmhidden").scrollTop(0).removeClass("mmsubopened").addClass("mmcurrent"), setTimeout((function() { $currobj.addClass("mmhidden") }), delay_tab), !1) : _this.hasClass("mm-close") ? (_parent.closemm(mmpanel), !1) : void 0
            }))
        })), $(".mm-fullscreen-bg").click((function(e) { e.preventDefault(), _parent.closemm(mmpanel) }))
    }, $.fn.openmm = function() {
        var _this = $(this);
        _this.show(), setTimeout((function() { $("body").addClass("mm-open"), _this.addClass("mmitemopen"), $(".mm-fullscreen-bg").fadeIn(delay_show_mm) }), 0)
    }, $.fn.closemm = function(mmpanel) {
        var _this = $(this);
        _this.addClass("mmhide"), $(".mm-fullscreen-bg").fadeOut(delay_hide_mm), setTimeout((function() { mm_destroy(_this, mmpanel) }), delay_hide_mm)
    },
    function(t, e, i) {
        var s, a, n, o, c, l, u, m;
        o = "datepicker", c = !1, l = { classes: "", inline: !1, language: "ru", startDate: new Date, firstDay: "", weekends: [6, 0], dateFormat: "", altField: "", altFieldDateFormat: "@", toggleSelected: !0, keyboardNav: !0, position: "bottom left", offset: 12, view: "days", minView: "days", showOtherMonths: !0, selectOtherMonths: !0, moveToOtherMonthsOnSelect: !0, showOtherYears: !0, selectOtherYears: !0, moveToOtherYearsOnSelect: !0, minDate: "", maxDate: "", disableNavWhenOutOfRange: !0, multipleDates: !1, multipleDatesSeparator: ",", range: !1, todayButton: !1, clearButton: !1, showEvent: "focus", autoClose: !1, monthsField: "monthsShort", prevHtml: '<svg><path d="M 17,12 l -5,5 l 5,5"></path></svg>', nextHtml: '<svg><path d="M 14,12 l 5,5 l -5,5"></path></svg>', navTitles: { days: "MM, <i>yyyy</i>", months: "yyyy", years: "yyyy1 - yyyy2" }, timepicker: !1, onlyTimepicker: !1, dateTimeSeparator: " ", timeFormat: "", minHours: 0, maxHours: 24, minMinutes: 0, maxMinutes: 59, hoursStep: 1, minutesStep: 1, onSelect: "", onShow: "", onHide: "", onChangeMonth: "", onChangeYear: "", onChangeDecade: "", onChangeView: "", onRenderCell: "" }, u = { ctrlRight: [17, 39], ctrlUp: [17, 38], ctrlLeft: [17, 37], ctrlDown: [17, 40], shiftRight: [16, 39], shiftUp: [16, 38], shiftLeft: [16, 37], shiftDown: [16, 40], altUp: [18, 38], altRight: [18, 39], altLeft: [18, 37], altDown: [18, 40], ctrlShiftUp: [16, 17, 38] }, m = function(t, a) { this.el = t, this.$el = e(t), this.opts = e.extend(!0, {}, l, a, this.$el.data()), s == i && (s = e("body")), this.opts.startDate || (this.opts.startDate = new Date), "INPUT" == this.el.nodeName && (this.elIsInput = !0), this.opts.altField && (this.$altField = "string" == typeof this.opts.altField ? e(this.opts.altField) : this.opts.altField), this.inited = !1, this.visible = !1, this.silent = !1, this.currentDate = this.opts.startDate, this.currentView = this.opts.view, this._createShortCuts(), this.selectedDates = [], this.views = {}, this.keys = [], this.minRange = "", this.maxRange = "", this._prevOnSelectValue = "", this.init() }, (n = m).prototype = {
                VERSION: "2.2.3",
                ...
                selectDate: function(t) {
                    var e = this,
                        ...
                        o = "";
                    if (Array.isArray(t)) t.forEach((function(t) { e.selectDate(t) }));
                ...
                _setInputValue: function() {
                    ...
                    i.altField && e.$altField.length && (t = (t = this.selectedDates.map((function(t) { return e.formatDate(a, t) }))).join(this.opts.multipleDatesSeparator), this.$altField.val(t)), n = n.join(this.opts.multipleDatesSeparator), this.$el.val(n)
                },
                ...
                _registerKey: function(t) { this.keys.some((function(e) { return e == t })) || this.keys.push(t) },
                ...
                _isHotKeyPressed: function() {
                    var t, e = !1,
                        s = this.keys.sort();
                    for (var a in u) t = u[a], s.length == t.length && t.every((function(t, e) { return t == s[e] })) && (this._trigger("hotKey", a), e = !0);
                    return e
                },
                ...
                _onKeyUpGeneral: function(t) { this.$el.val() || this.clear() },
                ...
                _onMouseLeaveCell: function(t) { e(t.target).closest(".datepicker--cell").removeClass("-focus-"), this.silent = !0, this.focused = "", this.silent = !1 },
            ...
            }, n.less = function(t, e, i) { return !(!t || !e) && e.getTime() < t.getTime() }, n.bigger = function(t, e, i) { return !(!t || !e) && e.getTime() > t.getTime() }, n.getLeadingZeroNum = function(t) { return parseInt(t) < 10 ? "0" + t : t }, n.resetTime = function(t) { return "object" == typeof t ? (t = n.getParsedDate(t), new Date(t.year, t.month, t.date)) : void 0 }, e.fn.datepicker = function(t) {
            ...
            }, e.fn.datepicker.Constructor = m, e.fn.datepicker.language = { ru: { days: ["Ð’Ð¾ÑÐºÑ€ÐµÑÐµÐ½ÑŒÐµ", "ÐŸÐ¾Ð½ÐµÐ´ÐµÐ»ÑŒÐ½Ð¸Ðº", "Ð’Ñ‚Ð¾Ñ€Ð½Ð¸Ðº", "Ð¡Ñ€ÐµÐ´Ð°", "Ð§ÐµÑ‚Ð²ÐµÑ€Ð³", "ÐŸÑÑ‚Ð½Ð¸Ñ†Ð°", "Ð¡ÑƒÐ±Ð±Ð¾Ñ‚Ð°"], daysShort: ["Ð’Ð¾Ñ", "ÐŸÐ¾Ð½", "Ð’Ñ‚Ð¾", "Ð¡Ñ€Ðµ", "Ð§ÐµÑ‚", "ÐŸÑÑ‚", "Ð¡ÑƒÐ±"], daysMin: ["Ð’Ñ", "ÐŸÐ½", "Ð’Ñ‚", "Ð¡Ñ€", "Ð§Ñ‚", "ÐŸÑ‚", "Ð¡Ð±"], months: ["Ð¯Ð½Ð²Ð°Ñ€ÑŒ", "Ð¤ÐµÐ²Ñ€Ð°Ð»ÑŒ", "ÐœÐ°Ñ€Ñ‚", "ÐÐ¿Ñ€ÐµÐ»ÑŒ", "ÐœÐ°Ð¹", "Ð˜ÑŽÐ½ÑŒ", "Ð˜ÑŽÐ»ÑŒ", "ÐÐ²Ð³ÑƒÑÑ‚", "Ð¡ÐµÐ½Ñ‚ÑÐ±Ñ€ÑŒ", "ÐžÐºÑ‚ÑÐ±Ñ€ÑŒ", "ÐÐ¾ÑÐ±Ñ€ÑŒ", "Ð”ÐµÐºÐ°Ð±Ñ€ÑŒ"], monthsShort: ["Ð¯Ð½Ð²", "Ð¤ÐµÐ²", "ÐœÐ°Ñ€", "ÐÐ¿Ñ€", "ÐœÐ°Ð¹", "Ð˜ÑŽÐ½", "Ð˜ÑŽÐ»", "ÐÐ²Ð³", "Ð¡ÐµÐ½", "ÐžÐºÑ‚", "ÐÐ¾Ñ", "Ð”ÐµÐº"], today: "Ð¡ÐµÐ³Ð¾Ð´Ð½Ñ", clear: "ÐžÑ‡Ð¸ÑÑ‚Ð¸Ñ‚ÑŒ", dateFormat: "dd.mm.yyyy", timeFormat: "hh:ii", firstDay: 1 } }, e((function() { e(".datepicker-here").datepicker() })),
            function() {
                ...
                s.Body = function(t, i, s) { this.d = t, this.type = i, this.opts = s, this.$el = e(""), this.opts.onlyTimepicker || this.init() }, s.Body.prototype = {
                    ...
                    _getDayNamesHtml: function(t, e, s, a) { return e = e != i ? e : t, s = s || "", (a = a != i ? a : 0) > 7 ? s : 7 == e ? this._getDayNamesHtml(t, 0, s, ++a) : (s += '<div class="datepicker--day-name' + (this.d.isWeekend(e) ? " -weekend-" : "") + '">' + this.d.loc.daysMin[e] + "</div>", this._getDayNamesHtml(t, ++e, s, ++a)) },
                    _getCellContents: function(t, e) {
                        ...
                        return r.onRenderCell && (l = (d = r.onRenderCell(t, e) || {}).html ? d.html : l, i += d.classes ? " " + d.classes : ""), r.range && (a.isSame(h, t, e) && (i += " -range-from-"), a.isSame(o, t, e) && (i += " -range-to-"), 1 == n.selectedDates.length && n.focused ? ((a.bigger(h, t) && a.less(n.focused, t) || a.less(o, t) && a.bigger(n.focused, t)) && (i += " -in-range-"), a.less(o, t) && a.isSame(n.focused, t) && (i += " -range-from-"), a.bigger(h, t) && a.isSame(n.focused, t) && (i += " -range-to-")) : 2 == n.selectedDates.length && a.bigger(h, t) && a.less(o, t) && (i += " -in-range-")), a.isSame(s, t, e) && (i += " -current-"), n.focused && a.isSame(t, n.focused, e) && (i += " -focus-"), n._isSelected(t, e) && (i += " -selected-"), (!n._isInRange(t, e) || d.disabled) && (i += " -disabled-"), { html: l, classes: i }
                    },
                    _getDaysHtml: function(t) { for (var o, r, e = a.getDaysCount(t), i = new Date(t.getFullYear(), t.getMonth(), 1).getDay(), s = new Date(t.getFullYear(), t.getMonth(), e).getDay(), n = i - this.d.loc.firstDay, h = 6 - s + this.d.loc.firstDay, d = "", l = 1 - (n = 0 > n ? n + 7 : n), u = e + (h = h > 6 ? h - 7 : h); u >= l; l++) r = t.getFullYear(), o = t.getMonth(), d += this._getDayHtml(new Date(r, o, l)); return d },
                    ...
                    _getYearsHtml: function(t) { for (var e = (a.getParsedDate(t), a.getDecade(t)), s = "", n = e[0] - 1; n <= e[1] + 1; n++) s += this._getYearHtml(new Date(n, 0)); return s },
                ...
                a.Navigation = function(t, e) { this.d = t, this.opts = e, this.$buttonsContainer = "", this.init() }, a.Navigation.prototype = {
                    ...
                    _render: function() {
                        var i = this._getTitle(this.d.currentDate),
                            s = n.template('<div class="datepicker--nav-action" data-action="prev">#{prevHtml}</div><div class="datepicker--nav-title">#{title}</div><div class="datepicker--nav-action" data-action="next">#{nextHtml}</div>', e.extend({ title: i }, this.opts));
                    ...
                    _addButtonsContainer: function() { this.d.$datepicker.append('<div class="datepicker--buttons"></div>'), this.$buttonsContainer = e(".datepicker--buttons", this.d.$datepicker) },
    ...
    function e(t, n, r) {
            ...
            function mountJQuery(jQuery) {
                jQuery.fn.perfectScrollbar = function(settingOrCommand) {
                    return this.each((function() {
                        ...
                        } else { var command = settingOrCommand; "update" === command ? ps.update(this) : "destroy" === command && ps.destroy(this) }
                        return jQuery(this)
                    }))
                }
            }
        ...
        2: [function(require, module, exports) {
            ...
            }, exports.list = function(element) { return element.classList ? Array.prototype.slice.apply(element.classList) : element.className.split(" ") }
        }, {}],
        3: [function(require, module, exports) {
            "use strict";
            var DOM = {};
            DOM.e = function(tagName, className) { var element = document.createElement(tagName); return element.className = className, element }, DOM.appendTo = function(child, parent) { return parent.appendChild(child), child }, DOM.css = function(element, styleNameOrObject, styleValue) { return "object" == typeof styleNameOrObject ? function cssMultiSet(element, obj) { for (var key in obj) { var val = obj[key]; "number" == typeof val && (val = val.toString() + "px"), element.style[key] = val } return element }(element, styleNameOrObject) : void 0 === styleValue ? function cssGet(element, styleName) { return window.getComputedStyle(element)[styleName] }(element, styleNameOrObject) : function cssSet(element, styleName, styleValue) { return "number" == typeof styleValue && (styleValue = styleValue.toString() + "px"), element.style[styleName] = styleValue, element }(element, styleNameOrObject, styleValue) }, DOM.matches = function(element, query) { return void 0 !== element.matches ? element.matches(query) : void 0 !== element.matchesSelector ? element.matchesSelector(query) : void 0 !== element.webkitMatchesSelector ? element.webkitMatchesSelector(query) : void 0 !== element.mozMatchesSelector ? element.mozMatchesSelector(query) : void 0 !== element.msMatchesSelector ? element.msMatchesSelector(query) : void 0 }, DOM.remove = function(element) { void 0 !== element.remove ? element.remove() : element.parentNode && element.parentNode.removeChild(element) }, DOM.queryChildren = function(element, selector) { return Array.prototype.filter.call(element.childNodes, (function(child) { return DOM.matches(child, selector) })) }, module.exports = DOM
        }, {}],
        4: [function(require, module, exports) {
            "use strict";
            var EventElement = function(element) { this.element = element, this.events = {} };
            EventElement.prototype.bind = function(eventName, handler) { void 0 === this.events[eventName] && (this.events[eventName] = []), this.events[eventName].push(handler), this.element.addEventListener(eventName, handler, !1) }, EventElement.prototype.unbind = function(eventName, handler) {
                var isHandlerProvided = void 0 !== handler;
                this.events[eventName] = this.events[eventName].filter((function(hdlr) { return !(!isHandlerProvided || hdlr === handler) || (this.element.removeEventListener(eventName, hdlr, !1), !1) }), this)
            }, EventElement.prototype.unbindAll = function() { for (var name in this.events) this.unbind(name) };
            var EventManager = function() { this.eventElements = [] };
            EventManager.prototype.eventElement = function(element) { var ee = this.eventElements.filter((function(eventElement) { return eventElement.element === element }))[0]; return void 0 === ee && (ee = new EventElement(element), this.eventElements.push(ee)), ee }, EventManager.prototype.bind = function(element, eventName, handler) { this.eventElement(element).bind(eventName, handler) }, EventManager.prototype.unbind = function(element, eventName, handler) { this.eventElement(element).unbind(eventName, handler) }, EventManager.prototype.unbindAll = function() { for (var i = 0; i < this.eventElements.length; i++) this.eventElements[i].unbindAll() }, EventManager.prototype.once = function(element, eventName, handler) {
                var ee = this.eventElement(element),
                    onceHandler = function(e) { ee.unbind(eventName, onceHandler), handler(e) };
        ...
        8: [function(require, module, exports) {
            "use strict";
            module.exports = { maxScrollbarLength: null, minScrollbarLength: null, scrollXMarginOffset: 0, scrollYMarginOffset: 0, stopPropagationOnClick: !0, suppressScrollX: !1, suppressScrollY: !1, swipePropagation: !0, useBothWheelAxes: !1, useKeyboard: !0, useSelectionScroll: !1, wheelPropagation: !1, wheelSpeed: 1, theme: "default" }
        }, {}],
        ...
        10: [function(require, module, exports) {
            ...
            module.exports = function(element) {
                ! function bindClickRailHandler(element, i) {
                    function pageOffset(el) { return el.getBoundingClientRect() }
        ...
        11: [function(require, module, exports) {
            ...
            function bindMouseScrollXHandler(element, i) {
                ...
                var mouseMoveHandler = function(e) {
                    ...
                    mouseUpHandler = function() { h.stopScrolling(element, "x"), i.event.unbind(i.ownerDocument, "mousemove", mouseMoveHandler) };
                i.event.bind(i.scrollbarX, "mousedown", (function(e) { currentPageX = e.pageX, currentLeft = h.toInt(d.css(i.scrollbarX, "left")) * i.railXRatio, h.startScrolling(element, "x"), i.event.bind(i.ownerDocument, "mousemove", mouseMoveHandler), i.event.once(i.ownerDocument, "mouseup", mouseUpHandler), e.stopPropagation(), e.preventDefault() }))
            }
            ...
            function bindMouseScrollYHandler(element, i) {
                ...
                var mouseMoveHandler = function(e) {
                    ...
                    mouseUpHandler = function() { h.stopScrolling(element, "y"), i.event.unbind(i.ownerDocument, "mousemove", mouseMoveHandler) };
                i.event.bind(i.scrollbarY, "mousedown", (function(e) { currentPageY = e.pageY, currentTop = h.toInt(d.css(i.scrollbarY, "top")) * i.railYRatio, h.startScrolling(element, "y"), i.event.bind(i.ownerDocument, "mousemove", mouseMoveHandler), i.event.once(i.ownerDocument, "mouseup", mouseUpHandler), e.stopPropagation(), e.preventDefault() }))
            }
            module.exports = function(element) {
                var i = instances.get(element);
        ...
        12: [function(require, module, exports) {
            ...
            function bindKeyboardHandler(element, i) {
                var hovered = !1;
                i.event.bind(element, "mouseenter", (function() { hovered = !0 })), i.event.bind(element, "mouseleave", (function() { hovered = !1 }));
                var shouldPrevent = !1;
                i.event.bind(i.ownerDocument, "keydown", (function(e) {
                    if (!e.isDefaultPrevented || !e.isDefaultPrevented()) {
                        ...
                        if (hovered || focused) {
                            ...
                            if (activeElement) { for (; activeElement.shadowRoot;) activeElement = activeElement.shadowRoot.activeElement; if (h.isEditable(activeElement)) return }
                            var deltaX = 0,
                                deltaY = 0;
                            switch (e.which) {
                                case 37:
        ...
        13: [function(require, module, exports) {
            ...
            module.exports = function(element) { bindMouseWheelHandler(element, instances.get(element)) }
        }, { "../instances": 18, "../update-geometry": 19, "../update-scroll": 20 }],
        14: [function(require, module, exports) {
            "use strict";
            var instances = require("../instances"),
                updateGeometry = require("../update-geometry");
            module.exports = function(element) {! function bindNativeScrollHandler(element, i) { i.event.bind(element, "scroll", (function() { updateGeometry(element) })) }(element, instances.get(element)) }
        ...
        15: [function(require, module, exports) {
            ...
            function bindSelectionHandler(element, i) {
                ...
                function stopScrolling() { scrollingLoop && (clearInterval(scrollingLoop), scrollingLoop = null), h.stopScrolling(element) }
                var isSelected = !1;
                i.event.bind(i.ownerDocument, "selectionchange", (function() { element.contains(function getRangeNode() { var selection = window.getSelection ? window.getSelection() : document.getSelection ? document.getSelection() : ""; return 0 === selection.toString().length ? null : selection.getRangeAt(0).commonAncestorContainer }()) ? isSelected = !0 : (isSelected = !1, stopScrolling()) })), i.event.bind(window, "mouseup", (function() { isSelected && (isSelected = !1, stopScrolling()) })), i.event.bind(window, "mousemove", (function(e) {
                    if (isSelected) {
                        var mousePosition = { x: e.pageX, y: e.pageY },
                            containerGeometry = { left: element.offsetLeft, right: element.offsetLeft + element.offsetWidth, top: element.offsetTop, bottom: element.offsetTop + element.offsetHeight };
                        mousePosition.x < containerGeometry.left + 3 ? (scrollDiff.left = -5, h.startScrolling(element, "x")) : mousePosition.x > containerGeometry.right - 3 ? (scrollDiff.left = 5, h.startScrolling(element, "x")) : scrollDiff.left = 0, mousePosition.y < containerGeometry.top + 3 ? (scrollDiff.top = containerGeometry.top + 3 - mousePosition.y < 5 ? -5 : -20, h.startScrolling(element, "y")) : mousePosition.y > containerGeometry.bottom - 3 ? (scrollDiff.top = mousePosition.y - containerGeometry.bottom + 3 < 5 ? 5 : 20, h.startScrolling(element, "y")) : scrollDiff.top = 0, 0 === scrollDiff.top && 0 === scrollDiff.left ? stopScrolling() : function startScrolling() { scrollingLoop || (scrollingLoop = setInterval((function() { instances.get(element) ? (updateScroll(element, "top", element.scrollTop + scrollDiff.top), updateScroll(element, "left", element.scrollLeft + scrollDiff.left), updateGeometry(element)) : clearInterval(scrollingLoop) }), 50)) }()
                    }
                }))
            }
            module.exports = function(element) { bindSelectionHandler(element, instances.get(element)) }
        }, { "../../lib/helper": 6, "../instances": 18, "../update-geometry": 19, "../update-scroll": 20 }],
        16: [function(require, module, exports) {
            ...
            function bindTouchHandler(element, i, supportsTouch, supportsIePointer) {
                ...
                function globalTouchStart() { inGlobalTouch = !0 }

                function globalTouchEnd() { inGlobalTouch = !1 }

                function getTouch(e) { return e.targetTouches ? e.targetTouches[0] : e }

                function shouldHandle(e) { return !(!e.targetTouches || 1 !== e.targetTouches.length) || !(!e.pointerType || "mouse" === e.pointerType || e.pointerType === e.MSPOINTER_TYPE_MOUSE) }
                    ...
                    if (!inGlobalTouch && inLocalTouch && shouldHandle(e)) {
                        ...
                        timeGap > 0 && (speed.x = differenceX / timeGap, speed.y = differenceY / timeGap, startTime = currentTime),
                            function shouldPreventDefault(deltaX, deltaY) {
                                ...
                                if (magnitudeY > magnitudeX) { if (deltaY < 0 && scrollTop === i.contentHeight - i.containerHeight || deltaY > 0 && 0 === scrollTop) return !i.settings.swipePropagation } else if (magnitudeX > magnitudeY && (deltaX < 0 && scrollLeft === i.contentWidth - i.containerWidth || deltaX > 0 && 0 === scrollLeft)) return !i.settings.swipePropagation;
                                return !0
                            }(differenceX, differenceY) && (e.stopPropagation(), e.preventDefault())
                    }
                }

                function touchEnd() {!inGlobalTouch && inLocalTouch && (inLocalTouch = !1, clearInterval(easingLoop), easingLoop = setInterval((function() { instances.get(element) ? Math.abs(speed.x) < .01 && Math.abs(speed.y) < .01 ? clearInterval(easingLoop) : (applyTouchMove(30 * speed.x, 30 * speed.y), speed.x *= .8, speed.y *= .8) : clearInterval(easingLoop) }), 10)) }
            ...
            module.exports = function(element, supportsTouch, supportsIePointer) { bindTouchHandler(element, instances.get(element), supportsTouch, supportsIePointer) }
        }, { "../instances": 18, "../update-geometry": 19, "../update-scroll": 20 }],
        ...
        18: [function(require, module, exports) {
            ...
            function Instance(element) {
                ...
                function focus() { cls.add(element, "ps-focus") }
            ...
            function getId(element) { return void 0 === element.dataset ? element.getAttribute("data-ps-id") : element.dataset.psId }
            exports.add = function(element) { var newId = guid(); return function setId(element, id) { void 0 === element.dataset ? element.setAttribute("data-ps-id", id) : element.dataset.psId = id }(element, newId), instances[newId] = new Instance(element), instances[newId] }, exports.remove = function(element) {
                delete instances[getId(element)],
                    function removeId(element) { void 0 === element.dataset ? element.removeAttribute("data-ps-id") : delete element.dataset.psId }(element)
            }, exports.get = function(element) { return instances[getId(element)] }
        ...
        20: [function(require, module, exports) {
            ...
            upEvent.initEvent("ps-scroll-up", !0, !0), downEvent.initEvent("ps-scroll-down", !0, !0), leftEvent.initEvent("ps-scroll-left", !0, !0), rightEvent.initEvent("ps-scroll-right", !0, !0), yEvent.initEvent("ps-scroll-y", !0, !0), xEvent.initEvent("ps-scroll-x", !0, !0), xStartEvent.initEvent("ps-x-reach-start", !0, !0), xEndEvent.initEvent("ps-x-reach-end", !0, !0), yStartEvent.initEvent("ps-y-reach-start", !0, !0), yEndEvent.initEvent("ps-y-reach-end", !0, !0), module.exports = function(element, axis, value) { if (void 0 === element) throw "You must provide an element to the update-scroll function"; if (void 0 === axis) throw "You must provide an axis to the update-scroll function"; if (void 0 === value) throw "You must provide a value to the update-scroll function"; "top" === axis && value <= 0 && (element.scrollTop = value = 0, element.dispatchEvent(yStartEvent)), "left" === axis && value <= 0 && (element.scrollLeft = value = 0, element.dispatchEvent(xStartEvent)); var i = instances.get(element); "top" === axis && value >= i.contentHeight - i.containerHeight && (element.scrollTop = value = i.contentHeight - i.containerHeight, element.dispatchEvent(yEndEvent)), "left" === axis && value >= i.contentWidth - i.containerWidth && (element.scrollLeft = value = i.contentWidth - i.containerWidth, element.dispatchEvent(xEndEvent)), lastTop || (lastTop = element.scrollTop), lastLeft || (lastLeft = element.scrollLeft), "top" === axis && value < lastTop && element.dispatchEvent(upEvent), "top" === axis && value > lastTop && element.dispatchEvent(downEvent), "left" === axis && value < lastLeft && element.dispatchEvent(leftEvent), "left" === axis && value > lastLeft && element.dispatchEvent(rightEvent), "top" === axis && (element.scrollTop = lastTop = value, element.dispatchEvent(yEvent)), "left" === axis && (element.scrollLeft = lastLeft = value, element.dispatchEvent(xEvent)) }
        }, { "./instances": 18 }],
    ...
    function(d, h, l, m) {
        var k = {
            ...
            setTintPosition: function(b) { this.nzOffset = this.$elem.offset(), this.tintpos = String(-1 * (b.pageX - this.nzOffset.left - this.zoomLens.width() / 2)), this.tintposy = String(-1 * (b.pageY - this.nzOffset.top - this.zoomLens.height() / 2)), this.Etoppos && (this.tintposy = 0), this.Eloppos && (this.tintpos = 0), this.Eboppos && (this.tintposy = -1 * (this.nzHeight - this.zoomLens.height() - 2 * this.options.lensBorderSize)), this.Eroppos && (this.tintpos = -1 * (this.nzWidth - this.zoomLens.width() - 2 * this.options.lensBorderSize)), this.options.tint && (this.fullheight && (this.tintposy = 0), this.fullwidth && (this.tintpos = 0), this.zoomTintImage.css({ left: this.tintpos + "px" }), this.zoomTintImage.css({ top: this.tintposy + "px" })) },
            swaptheimage: function(b, a) {
                var c = this,
                    e = new Image;
                c.options.loadingIcon && (c.spinner = d("<div style=\"background: url('" + c.options.loadingIcon + "') no-repeat center;height:" + c.nzHeight + "px;width:" + c.nzWidth + 'px;z-index: 2000;position: absolute; background-position: center center;"></div>'), c.$elem.after(c.spinner)), c.options.onImageSwap(c.$elem), e.onload = function() { c.largeWidth = e.width, c.largeHeight = e.height, c.zoomImage = a, c.zoomWindow.css({ "background-size": c.largeWidth + "px " + c.largeHeight + "px" }), c.zoomWindow.css({ "background-size": c.largeWidth + "px " + c.largeHeight + "px" }), c.swapAction(b, a) }, e.src = a
            },
            swapAction: function(b, a) {
                var c = this,
                    e = new Image;
                if (e.onload = function() { c.nzHeight = e.height, c.nzWidth = e.width, c.options.onImageSwapComplete(c.$elem), c.doneCallback() }, e.src = b, c.currentZoomLevel = c.options.zoomLevel, c.options.maxZoomLevel = !1, "lens" == c.options.zoomType && c.zoomLens.css({ backgroundImage: "url('" + a + "')" }), "window" == c.options.zoomType && c.zoomWindow.css({ backgroundImage: "url('" + a + "')" }), "inner" == c.options.zoomType && c.zoomWindow.css({ backgroundImage: "url('" + a + "')" }), c.currentImage = a, c.options.imageCrossfade) {
                    var f = c.$elem,
                        g = f.clone();
                    c.$elem.attr("src", b), c.$elem.after(g), g.stop(!0).fadeOut(c.options.imageCrossfade, (function() { d(this).remove() })), c.$elem.width("auto").removeAttr("width"), c.$elem.height("auto").removeAttr("height"), f.fadeIn(c.options.imageCrossfade), c.options.tint && "inner" != c.options.zoomType && (g = (f = c.zoomTintImage).clone(), c.zoomTintImage.attr("src", a), c.zoomTintImage.after(g), g.stop(!0).fadeOut(c.options.imageCrossfade, (function() { d(this).remove() })), f.fadeIn(c.options.imageCrossfade), c.zoomTint.css({ height: c.$elem.height() }), c.zoomTint.css({ width: c.$elem.width() })), c.zoomContainer.css("height", c.$elem.height()), c.zoomContainer.css("width", c.$elem.width()), "inner" != c.options.zoomType || c.options.constrainType || (c.zoomWrap.parent().css("height", c.$elem.height()), c.zoomWrap.parent().css("width", c.$elem.width()), c.zoomWindow.css("height", c.$elem.height()), c.zoomWindow.css("width", c.$elem.width()))
            ...
            getGalleryList: function() {
                ...
                return b.gallerylist = [], b.options.gallery ? d("#" + b.options.gallery + " a").each((function() {
                    var a = "";
                    d(this).data("zoom-image") ? a = d(this).data("zoom-image") : d(this).data("image") && (a = d(this).data("image")), a == b.zoomImage ? b.gallerylist.unshift({ href: "" + a, title: d(this).find("img").attr("title") }) : b.gallerylist.push({ href: "" + a, title: d(this).find("img").attr("title") })
    ...
    function(t, e) { "object" == typeof module && module.exports ? module.exports = e() : t.EvEmitter = e() }("undefined" != typeof window ? window : this, (function() {
        ...
        }, e.off = function(t, e) { let i = this._events && this._events[t]; if (!i || !i.length) return this; let s = i.indexOf(e); return -1 != s && i.splice(s, 1), this }, e.emitEvent = function(t, e) {
     ...
     * MIT License
     */
    function(t, e) { "object" == typeof module && module.exports ? module.exports = e(t, require("ev-emitter")) : t.imagesLoaded = e(t, t.EvEmitter) }("undefined" != typeof window ? window : this, (function(t, e) {
        let i = t.jQuery,
            s = t.console;

        function n(t, e, o) { if (!(this instanceof n)) return new n(t, e, o); let r = t; var h; "string" == typeof t && (r = document.querySelectorAll(t)), r ? (this.elements = (h = r, Array.isArray(h) ? h : "object" == typeof h && "number" == typeof h.length ? [...h] : [h]), this.options = {}, "function" == typeof e ? o = e : Object.assign(this.options, e), o && this.on("always", o), this.getImages(), i && (this.jqDeferred = new i.Deferred), setTimeout(this.check.bind(this))) : s.error(`Bad element for imagesLoaded ${r||t}`) }
        n.prototype = Object.create(e.prototype), n.prototype.getImages = function() { this.images = [], this.elements.forEach(this.addElementImages, this) };
        const o = [1, 9, 11];
        n.prototype.addElementImages = function(t) { "IMG" === t.nodeName && this.addImage(t), !0 === this.options.background && this.addElementBackgroundImages(t); let { nodeType: e } = t; if (!e || !o.includes(e)) return; let i = t.querySelectorAll("img"); for (let t of i) this.addImage(t); if ("string" == typeof this.options.background) { let e = t.querySelectorAll(this.options.background); for (let t of e) this.addElementBackgroundImages(t) } };
        const r = /url\((['"])?(.*?)\1\)/gi;

        function h(t) { this.img = t }

        function d(t, e) { this.url = t, this.element = e, this.img = new Image }
        return n.prototype.addElementBackgroundImages = function(t) {
            ...
            let t = (t, e, i) => { setTimeout((() => { this.progress(t, e, i) })) };
            this.images.forEach((function(e) { e.once("progress", t), e.check() }))
        }, n.prototype.progress = function(t, e, i) { this.progressedCount++, this.hasAnyBroken = this.hasAnyBroken || !t.isLoaded, this.emitEvent("progress", [this, t, e]), this.jqDeferred && this.jqDeferred.notify && this.jqDeferred.notify(this, t), this.progressedCount === this.images.length && this.complete(), this.options.debug && s && s.log(`progress: ${i}`, t, e) }, n.prototype.complete = function() {
            let t = this.hasAnyBroken ? "fail" : "done";
            if (this.isComplete = !0, this.emitEvent(t, [this]), this.emitEvent("always", [this]), this.jqDeferred) {
                let t = this.hasAnyBroken ? "reject" : "resolve";
                this.jqDeferred[t](this)
            }
        }, h.prototype = Object.create(e.prototype), h.prototype.check = function() { this.getIsImageComplete() ? this.confirm(0 !== this.img.naturalWidth, "naturalWidth") : (this.proxyImage = new Image, this.img.crossOrigin && (this.proxyImage.crossOrigin = this.img.crossOrigin), this.proxyImage.addEventListener("load", this), this.proxyImage.addEventListener("error", this), this.img.addEventListener("load", this), this.img.addEventListener("error", this), this.proxyImage.src = this.img.currentSrc || this.img.src) }, h.prototype.getIsImageComplete = function() { return this.img.complete && this.img.naturalWidth }, h.prototype.confirm = function(t, e) {
            this.isLoaded = t;
            ...
            let e = "on" + t.type;
            this[e] && this[e](t)
        }, h.prototype.onload = function() { this.confirm(!0, "onload"), this.unbindEvents() }, h.prototype.onerror = function() { this.confirm(!1, "onerror"), this.unbindEvents() }, h.prototype.unbindEvents = function() { this.proxyImage.removeEventListener("load", this), this.proxyImage.removeEventListener("error", this), this.img.removeEventListener("load", this), this.img.removeEventListener("error", this) }, d.prototype = Object.create(h.prototype), d.prototype.check = function() { this.img.addEventListener("load", this), this.img.addEventListener("error", this), this.img.src = this.url, this.getIsImageComplete() && (this.confirm(0 !== this.img.naturalWidth, "naturalWidth"), this.unbindEvents()) }, d.prototype.unbindEvents = function() { this.img.removeEventListener("load", this), this.img.removeEventListener("error", this) }, d.prototype.confirm = function(t, e) { this.isLoaded = t, this.emitEvent("progress", [this, this.element, e]) }, n.makeJQueryPlugin = function(e) {
            (e = e || t.jQuery) && (i = e, i.fn.imagesLoaded = function(t, e) { return new n(this, t, e).jqDeferred.promise(i(this)) })
    ...
    function(t, e) { "object" == typeof exports && "undefined" != typeof module ? e(exports, require("jquery"), require("popper.js")) : "function" == typeof define && define.amd ? define(["exports", "jquery", "popper.js"], e) : e(t.bootstrap = {}, t.jQuery, t.Popper) }(this, (function(t, e, n) {
        ...
        var o, a, l, h, c, u, g, p, m, v, E, T, y, C, b, N, O, k, P = function(t) {
                ...
                return e = ("undefined" == typeof window || !window.QUnit) && { end: "transitionend" }, t.fn.emulateTransitionEnd = function n(e) {
                    var n = this,
                        s = !1;
            ...
            L = (a = "alert", h = "." + (l = "bs.alert"), c = (o = e).fn[a], u = { CLOSE: "close" + h, CLOSED: "closed" + h, CLICK_DATA_API: "click" + h + ".data-api" }, "alert", "fade", "show", g = function() {
                ...
                return e.close = function(t) {
                    ...
                    var e = this;
                    o(t).removeClass("show"), P.supportsTransitionEnd() && o(t).hasClass("fade") ? o(t).one(P.TRANSITION_END, (function(n) { return e._destroyElement(t, n) })).emulateTransitionEnd(150) : this._destroyElement(t)
            ...
            R = (m = "button", E = "." + (v = "bs.button"), T = ".data-api", y = (p = e).fn[m], C = "active", "btn", "focus", b = '[data-toggle^="button"]', '[data-toggle="buttons"]', "input", ".active", N = ".btn", O = { CLICK_DATA_API: "click" + E + T, FOCUS_BLUR_DATA_API: "focus" + E + T + " blur" + E + T }, k = function() {
                function t(t) { this._element = t }
                var e = t.prototype;
            ...
            j = function(t) {
                var e = "carousel",
                    ...
                    C = function() {
                        function o(e, n) { this._items = null, this._interval = null, this._activeElement = null, this._isPaused = !1, this._isSliding = !1, this.touchTimeout = null, this._config = this._getConfig(n), this._element = t(e)[0], this._indicatorsElement = t(this._element).find(y_INDICATORS)[0], this._addEventListeners() }
                        var C = o.prototype;
                        ...
                        }, C._getItemIndex = function(e) { return this._items = t.makeArray(t(e).parent().find(y_ITEM)), this._items.indexOf(e) }, C._getItemByDirection = function(t, e) {
                            var n = t === h,
                                i = t === c,
            ...
            H = function(t) {
                var e = "collapse",
                    ...
                    m = function() {
                        ...
                        }, o.setTransitioning = function(t) { this._isTransitioning = t }, o.dispose = function() { t.removeData(this._element, n), this._config = null, this._parent = null, this._element = null, this._triggerArray = null, this._isTransitioning = null }, o._getConfig = function(t) { return (t = r({}, a, t)).toggle = Boolean(t.toggle), P.typeCheckConfig(e, t, l), t }, o._getDimension = function() { return t(this._element).hasClass(_) ? _ : "height" }, o._getParent = function() {
                            var e = this,
                                n = null;
            ...
            W = function(t) {
                ...
                return t(document).on(c.KEYDOWN_DATA_API, E, L._dataApiKeydownHandler).on(c.KEYDOWN_DATA_API, y, L._dataApiKeydownHandler).on(c.CLICK_DATA_API + " " + c.KEYUP_DATA_API, L._clearMenus).on(c.CLICK_DATA_API, E, (function(e) { e.preventDefault(), e.stopPropagation(), L._jQueryInterface.call(t(this), "toggle") })).on(c.CLICK_DATA_API, ".dropdown form", (function(t) { t.stopPropagation() })), t.fn[e] = L._jQueryInterface, t.fn[e].Constructor = L, t.fn[e].noConflict = function() { return t.fn[e] = l, L._jQueryInterface }, L
            }(e),
            M = function(t) {
                var n = "bs.modal",
                    i = "." + n,
                    ...
                    p = function() {
                        function o(e, n) { this._config = this._getConfig(n), this._element = e, this._dialog = t(e).find(g_DIALOG)[0], this._backdrop = null, this._isShown = !1, this._isBodyOverflowing = !1, this._ignoreBackdropClick = !1, this._originalBodyPadding = 0, this._scrollbarWidth = 0 }
                        var p = o.prototype;
                        return p.toggle = function(t) { return this._isShown ? this.hide() : this.show(t) }, p.show = function(e) {
                            ...
                            if (!this._isTransitioning && !this._isShown) {
                                ...
                                t(this._element).trigger(i), this._isShown || i.isDefaultPrevented() || (this._isShown = !0, this._checkScrollbar(), this._setScrollbar(), this._adjustDialog(), t(document.body).addClass(f), this._setEscapeEvent(), this._setResizeEvent(), t(this._element).on(h.CLICK_DISMISS, g_DATA_DISMISS, (function(t) { return n.hide(t) })), t(this._dialog).on(h.MOUSEDOWN_DISMISS, (function() { t(n._element).one(h.MOUSEUP_DISMISS, (function(e) { t(e.target).is(n._element) && (n._ignoreBackdropClick = !0) })) })), this._showBackdrop((function() { return n._showElement(e) })))
                            }
                        }, p.hide = function(e) {
                            var n = this;
                        ...
                        }, p.dispose = function() { t.removeData(this._element, n), t(window, document, this._element, this._backdrop).off(i), this._config = null, this._element = null, this._dialog = null, this._backdrop = null, this._isShown = null, this._isBodyOverflowing = null, this._ignoreBackdropClick = null, this._scrollbarWidth = null }, p.handleUpdate = function() { this._adjustDialog() }, p._getConfig = function(t) { return t = r({}, a, t), P.typeCheckConfig("modal", t, l), t }, p._showElement = function(e) {
                            var n = this,
                            ...
                            if (this._isShown && this._config.backdrop) {
                                ...
                                if (this._backdrop = document.createElement("div"), this._backdrop.className = "modal-backdrop", i && t(this._backdrop).addClass(i), t(this._backdrop).appendTo(document.body), t(this._element).on(h.CLICK_DISMISS, (function(t) { n._ignoreBackdropClick ? n._ignoreBackdropClick = !1 : t.target === t.currentTarget && ("static" === n._config.backdrop ? n._element.focus() : n.hide()) })), s && P.reflow(this._backdrop), t(this._backdrop).addClass(_), !e) return;
                                if (!s) return void e();
                ...
                var e = "scrollspy",
                    ...
                    g = function() {
                        ...
                        return g.refresh = function() {
                            ...
                            var i = t(n.join(","));
                            i.hasClass("dropdown-item") ? (i.closest(f_DROPDOWN).find(f_DROPDOWN_TOGGLE).addClass(u), i.addClass(u)) : (i.addClass(u), i.parents(f_NAV_LIST_GROUP).prev(f_NAV_LINKS + ", " + f_LIST_ITEMS).addClass(u), i.parents(f_NAV_LIST_GROUP).prev(f_NAV_ITEMS).children(f_NAV_LINKS).addClass(u)), t(this._scrollElement).trigger(h.ACTIVATE, { relatedTarget: e })
                        }, g._clear = function() { t(this._selector).filter(f_ACTIVE).removeClass(u) }, o._jQueryInterface = function(e) {
                            return this.each((function() {
                                var i = t(this).data(n);
            ...
            V = function(t) {
                ...
                return t(document).on(r.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(e) { e.preventDefault(), v._jQueryInterface.call(t(this), "show") })), t.fn.tab = v._jQueryInterface, t.fn.tab.Constructor = v, t.fn.tab.noConflict = function() { return t.fn.tab = i, v._jQueryInterface }, v
            }(e);
    ...
    function(e) {
        var t = function(u, D, f) {
            ...
            var O = D.documentElement,
                ...
                J = function(e, t) { return a[t] || (a[t] = new RegExp("(\\s|^)" + t + "(\\s|$)")), a[t].test(e[$]("class") || "") && a[t] },
                K = function(e, t) { J(e, t) || e.setAttribute("class", (e[$]("class") || "").trim() + " " + t) },
                Q = function(e, t) {
                    var a;
                ...
                V = function(t, a, e) {
                    ...
                    e && V(t, a), r.forEach((function(e) { t[i](e, a) }))
                },
                X = function(e, t, a, i, r) { var n = D.createEvent("Event"); return a || (a = {}), a.instance = k, n.initEvent(t, !i, !r), n.detail = a, e.dispatchEvent(n), n },
                Y = function(e, t) { var a;!i && (a = u.picturefill || H.pf) ? (t && t.src && !e[$]("srcset") && e.setAttribute("srcset", t.src), a({ reevaluate: !0, elements: [e] })) : t && t.src && (e.src = t.src) },
                Z = function(e, t) { return (getComputedStyle(e, null) || {})[t] },
                s = function(e, t, a) { for (a = a || e.offsetWidth; a < H.minSize && t && !e._lazysizesWidth;) a = t.offsetWidth, t = t.parentNode; return a },
                ee = function() {
                    var a, i, t = [],
                        r = [],
                        n = t,
                        ...
                        e = function(e, t) { a && !t ? e.apply(this, arguments) : (n.push(e), i || (i = !0, (D.hidden ? I : U)(s))) };
                ...
                ae = function(e) {
                    var a, i = 0,
                        r = H.throttleDelay,
                        n = H.ricTimeout,
                        t = function() { a = !1, i = f.now(), e() },
                        s = o && n > 49 ? function() { o(t, { timeout: n }), n !== H.ricTimeout && (n = H.ricTimeout) } : te((function() { I(t) }), !0);
                    return function(e) {
                        var t;
                ...
                ie = function(e) {
                    var t, a, r = function() { t = null, e() },
                        n = function() {
                            var e = f.now() - a;
                            e < 99 ? I(n, 99 - e) : (o || r)(r)
                        };
                    return function() { a = f.now(), t || (t = I(n, 99)) }
                },
                e = function() {
                    var v, m, c, h, e, y, z, g, p, C, b, A, n = /^img$/i,
                        ...
                        M = 0,
                        N = -1,
                        L = function(e) { M--, (!e || M < 0 || !e.target) && (M = 0) },
                        x = function(e) { return null == A && (A = "hidden" == Z(D.body, "visibility")), A || !("hidden" == Z(e.parentNode, "visibility") && "hidden" == Z(e, "visibility")) },
                        W = function(e, t) {
                            var a, i = e,
                                r = x(e);
                        ...
                        i = te(S),
                        B = function(e) { i({ target: e.target }) },
                        F = function(e) {
                        ...
                        s = te((function(t, e, a, i, r) {
                            var n, s, o, l, u, f;
                            (u = X(t, "lazybeforeunveil", e)).defaultPrevented || (i && (a ? K(t, H.autosizesClass) : t.setAttribute("sizes", i)), s = t[$](H.srcsetAttr), n = t[$](H.srcAttr), r && (l = (o = t.parentNode) && j.test(o.nodeName || "")), f = e.firesLoad || "src" in t && (s || n || l), u = { target: t }, K(t, H.loadingClass), f && (clearTimeout(c), c = I(L, 2500), V(t, B, !0)), l && G.call(o.getElementsByTagName("source"), F), s ? t.setAttribute("srcset", s) : n && !l && (d.test(t.nodeName) ? function(e, t) {
                                var a = e.getAttribute("data-load-mode") || H.iframeLoadMode;
                                0 == a ? e.contentWindow.location.replace(t) : 1 == a && (e.src = t)
                            }(t, n) : t.src = n), r && (s || l) && Y(t, { src: n })), t._lazyRace && delete t._lazyRace, Q(t, H.lazyClass), ee((function() {
                                var e = t.complete && t.naturalWidth > 1;
                                f && !e || (e && K(t, H.fastLoadedClass), S(u), t._lazyCache = !0, I((function() { "_lazyCache" in t && delete t._lazyCache }), 9)), "lazy" == t.loading && M--
                            }), !0)
                        })),
                        R = function(e) {
                            if (!e._lazyRace) {
                        ...
                        r = ie((function() { H.loadMode = 3, a() })),
                        o = function() { 3 == H.loadMode && (H.loadMode = 2), r() },
                        l = function() { m || (f.now() - e < 999 ? I(l, 999) : (m = !0, H.loadMode = 3, a(), q("scroll", o, !0))) };
                    return {
                        _: function() {
                            e = f.now(), k.elements = D.getElementsByClassName(H.lazyClass), v = D.getElementsByClassName(H.lazyClass + " " + H.preloadClass), q("scroll", a, !0), q("resize", a, !0), q("pageshow", (function(e) {
                                if (e.persisted) {
                                    ...
                                    t.length && t.forEach && U((function() { t.forEach((function(e) { e.complete && R(e) })) }))
                                }
                            })), u.MutationObserver ? new MutationObserver(a).observe(O, { childList: !0, subtree: !0, attributes: !0 }) : (O[P]("DOMNodeInserted", a, !0), O[P]("DOMAttrModified", a, !0), setInterval(a, 999)), q("hashchange", a, !0), ["focus", "mouseover", "click", "load", "transitionend", "animationend"].forEach((function(e) { D[P](e, a, !0) })), /d$|^c/.test(D.readyState) ? l() : (q("load", l), D[P]("DOMContentLoaded", a), I(l, 2e4)), k.elements.length ? (t(), ee._lsFlush()) : a()
                        },
                        checkElems: a,
                        unveil: R,
                        _aLSL: o
                ...
                re = function() {
                    var a, n = te((function(e, t, a, i) {
                        ...
                        i = function(e, t, a) {
                            ...
                            r && (a = s(e, r, a), (i = X(e, "lazybeforesizes", { width: a, dataAttr: !!t })).defaultPrevented || (a = i.detail.width) && a !== e._lazysizesWidth && n(e, r, i, a))
                        },
                        t = ie((function() {
                            var e, t = a.length;
                            if (t)
                    ...
                    return { _: function() { a = D.getElementsByClassName(H.autosizesClass), q("resize", t) }, checkElems: t, updateElem: i }
                }(),
                t = function() {!t.i && D.getElementsByClassName && (t.i = !0, re._(), e._()) };
    ...
    function(e, t) {
        var a = function() { t(e.lazySizes), e.removeEventListener("lazyunveilread", a, !0) };
        ...
        e.addEventListener && (g = c.cfg, y = /\s+/g, b = /\s*\|\s+|\s+\|\s*/g, f = /^(.+?)(?:\s+\[\s*(.+?)\s*\])(?:\s+\[\s*(.+?)\s*\])?$/, r = /^\s*\(*\s*type\s*:\s*(.+?)\s*\)*\s*$/, l = /\(|\)|'/, s = { contain: 1, cover: 1 }, v = function(e, t) {
            var a;
            t && ((a = t.match(r)) && a[1] ? e.setAttribute("type", a[1]) : e.setAttribute("media", g.customMedia[t] || t))
        }, m = function(e) {
            var t, a, r, i, s;
            e.target._lazybgset && (a = (t = e.target)._lazybgset, (r = t.currentSrc || t.src) && (i = l.test(r) ? JSON.stringify(r) : r, (s = c.fire(a, "bgsetproxy", { src: r, useSrc: i, fullSrc: null })).defaultPrevented || (a.style.backgroundImage = s.detail.fullSrc || "url(" + s.detail.useSrc + ")")), t._lazybgsetLoading && (c.fire(a, "_lazyloaded", {}, !1, !0), delete t._lazybgsetLoading))
        }, addEventListener("lazybeforeunveil", (function(e) {
            var t, a, r, i, s, l, n, d, u, o;
            !e.defaultPrevented && (t = e.target.getAttribute("data-bgset")) && (u = e.target, (o = z.createElement("img")).alt = "", o._lazybgsetLoading = !0, e.detail.firesLoad = !0, a = t, r = u, i = o, s = z.createElement("picture"), l = r.getAttribute(g.sizesAttr), n = r.getAttribute("data-ratio"), d = r.getAttribute("data-optimumx"), r._lazybgset && r._lazybgset.parentNode == r && r.removeChild(r._lazybgset), Object.defineProperty(i, "_lazybgset", { value: r, writable: !0 }), Object.defineProperty(r, "_lazybgset", { value: s, writable: !0 }), a = a.replace(y, " ").split(b), s.style.display = "none", i.className = g.lazyClass, 1 != a.length || l || (l = "auto"), a.forEach((function(e) {
            ...
            })), l && (i.setAttribute(g.sizesAttr, l), r.removeAttribute(g.sizesAttr), r.removeAttribute("sizes")), d && i.setAttribute("data-optimumx", d), n && i.setAttribute("data-ratio", n), s.appendChild(i), r.appendChild(s), setTimeout((function() { c.loader.unveil(o), c.rAF((function() { c.fire(o, "_lazyloaded", {}, !0, !0), o.complete && m({ target: o }) })) })))
        })), z.addEventListener("load", m, !0), e.addEventListener("lazybeforesizes", (function(e) {
            var a, r, i;
            e.detail.instance == c && e.target._lazybgset && e.detail.dataAttr && (r = e.target._lazybgset, i = (getComputedStyle(r) || { getPropertyValue: function() {} }).getPropertyValue("background-size"), !s[i] && s[r.style.backgroundSize] && (i = r.style.backgroundSize), s[a = i] && (e.target._lazysizesParentFit = a, c.rAF((function() { e.target.setAttribute("data-parent-fit", a), e.target._lazysizesParentFit && delete e.target._lazysizesParentFit }))))
        }), !0), z.documentElement.addEventListener("lazybeforesizes", (function(e) { var t, a;!e.defaultPrevented && e.target._lazybgset && e.detail.instance == c && (e.detail.width = (t = e.target._lazybgset, a = c.gW(t, t.parentNode), (!t._lazysizesWidth || a > t._lazysizesWidth) && (t._lazysizesWidth = a), t._lazysizesWidth)) })))
    })),
    function($) {
        "use strict";
        var feature = {};
        ...
        $.fn.attr2 = function() { if (!hasProp) return this.attr.apply(this, arguments); var val = this.prop.apply(this, arguments); return val && val.jquery || "string" == typeof val ? val : this.attr.apply(this, arguments) }, $.fn.ajaxSubmit = function(options) {
            if (!this.length) return log("ajaxSubmit: skipping submit process - no element selected"), this;
            var method, action, url, $form = this;
            "function" == typeof options && (options = { success: options }), method = this.attr2("method"), (url = (url = "string" == typeof(action = this.attr2("action")) ? $.trim(action) : "") || window.location.href || "") && (url = (url.match(/^([^#]+)/) || [])[1]), options = $.extend(!0, { url: url, success: $.ajaxSettings.success, type: method || "GET", iframeSrc: /^https/i.test(window.location.href || "") ? "javascript:false" : "about:blank" }, options);
            var veto = {};
            ...
            var callbacks = [];
            if (options.resetForm && callbacks.push((function() { $form.resetForm() })), options.clearForm && callbacks.push((function() { $form.clearForm(options.includeHidden) })), !options.dataType && options.target) {
            ...
            options.success = function(data, status, xhr) { for (var context = options.context || this, i = 0, max = callbacks.length; i < max; i++) callbacks[i].apply(context, [data, status, xhr || $form, $form]) };
            ...
            !1 !== options.iframe && (options.iframe || shouldUseFrame) ? options.closeKeepAlive ? $.get(options.closeKeepAlive, (function() { jqxhr = fileUploadIframe(a) })) : jqxhr = fileUploadIframe(a) : jqxhr = (hasFileInputs || multipart) && fileAPI ? function fileUploadXhr(a) {
                ...
                return s.beforeSend = function(xhr, o) { o.data = formdata, beforeSend && beforeSend.call(this, xhr, o) }, $.ajax(s)
            ...
            function fileUploadIframe(a) {
                ...
                if ((s = $.extend(!0, {}, $.ajaxSettings, options)).context = s.context || s, id = "jqFormIO" + (new Date).getTime(), s.iframeTarget ? (n = ($io = $(s.iframeTarget)).attr2("name")) ? id = n : $io.attr2("name", id) : ($io = $('<iframe name="' + id + '" src="' + s.iframeSrc + '" />')).css({ position: "absolute", top: "-1000px", left: "-1000px" }), io = $io[0], xhr = {
                        aborted: 0,
                        responseText: null,
                        responseXML: null,
                        status: 0,
                        ...
                        abort: function(status) {
                            ...
                            try { io.contentWindow.document.execCommand && io.contentWindow.document.execCommand("Stop") } catch (ignore) {}
                ...
                function getDoc(frame) { var doc = null; try { frame.contentWindow && (doc = frame.contentWindow.document) } catch (err) { log("cannot get iframe.contentWindow document: " + err) } if (doc) return doc; try { doc = frame.contentDocument ? frame.contentDocument : frame.document } catch (err) { log("cannot get iframe.contentDocument: " + err), doc = frame.document } return doc }
                ...
                function doSubmit() {
                    var t = $form.attr2("target"),
                        a = $form.attr2("action");
                    form.setAttribute("target", id), method || form.setAttribute("method", "POST"), a != s.url && form.setAttribute("action", s.url), s.skipEncodingOverride || method && !/post/i.test(method) || $form.attr({ encoding: "multipart/form-data", enctype: "multipart/form-data" }), s.timeout && (timeoutHandle = setTimeout((function() { timedOut = !0, cb(1) }), s.timeout));
                    var extraInputs = [];
                    try {
                        if (s.extraData)
                        ...
                        s.iframeTarget || ($io.appendTo("body"), io.attachEvent ? io.attachEvent("onload", cb) : io.addEventListener("load", cb, !1)), setTimeout((function checkState() {
                            ...
                            } catch (e) { log("Server abort: ", e, " (", e.name, ")"), cb(2), timeoutHandle && clearTimeout(timeoutHandle), timeoutHandle = void 0 }
                        }), 15);
                        try { form.submit() } catch (err) { document.createElement("form").submit.apply(form) }
                    ...
                    if (!xhr.aborted && !callbackProcessed) {
                        ...
                        if (doc && doc.location.href != s.iframeSrc || timedOut) {
                            ...
                            try {
                                ...
                                xhr.responseText = docRoot ? docRoot.innerHTML : null, xhr.responseXML = doc.XMLDocument ? doc.XMLDocument : doc, isXml && (s.dataType = "xml"), xhr.getResponseHeader = function(header) { return { "content-type": s.dataType }[header] }, docRoot && (xhr.status = Number(docRoot.getAttribute("status")) || xhr.status, xhr.statusText = docRoot.getAttribute("statusText") || xhr.statusText);
            ...
            for (i = 0, max = els.length; i < max; i++)
                if ((n = (el = els[i]).name) && !el.disabled)
                    if (semantic && form.clk && "image" == el.type) form.clk == el && (a.push({ name: n, value: $(el).val(), type: el.type }), a.push({ name: n + ".x", value: form.clk_x }, { name: n + ".y", value: form.clk_y }));
                    else if ((v = $.fieldValue(el, !0)) && v.constructor == Array)
                for (elements && elements.push(el), j = 0, jmax = v.length; j < jmax; j++) a.push({ name: n, value: v[j] });
            ...
            } else null != v && (elements && elements.push(el), a.push({ name: n, value: v, type: el.type, required: el.required }));
            if (!semantic && form.clk) {
                var $input = $(form.clk),
                    input = $input[0];
                (n = input.name) && !input.disabled && "image" == input.type && (a.push({ name: n, value: $input.val() }), a.push({ name: n + ".x", value: form.clk_x }, { name: n + ".y", value: form.clk_y }))
            }
            return a
            ...
            return this.each((function() {
                ...
                if (n) {
                    ...
                    else null != v && a.push({ name: this.name, value: v })
                }
            })), $.param(a)
        ...
        }, $.fn.enable = function(b) { return void 0 === b && (b = !0), this.each((function() { this.disabled = !b })) }, $.fn.selected = function(select) {
    ...
    function(t) {
        t.extend(t.fn, {
            validate: function(e) {
                if (this.length) {
                    ...
                    return i || (this.attr("novalidate", "novalidate"), i = new t.validator(e, this[0]), t.data(this[0], "validator", i), i.settings.onsubmit && (this.validateDelegate(":submit", "click", (function(e) { i.settings.submitHandler && (i.submitButton = e.target), t(e.target).hasClass("cancel") && (i.cancelSubmit = !0), void 0 !== t(e.target).attr("formnovalidate") && (i.cancelSubmit = !0) })), this.submit((function(e) {
                        function s() { var s; return !i.settings.submitHandler || (i.submitButton && (s = t("<input type='hidden'/>").attr("name", i.submitButton.name).val(t(i.submitButton).val()).appendTo(i.currentForm)), i.settings.submitHandler.call(i, i.currentForm, e), i.submitButton && s.remove(), !1) }
            ...
            prototype: {
                ...
                element: function(e) { e = this.validationTargetFor(this.clean(e)), this.lastElement = e, this.prepareElement(e), this.currentElements = t(e); var i = !1 !== this.check(e); return i ? delete this.invalid[e.name] : this.invalid[e.name] = !0, this.numberOfInvalids() || (this.toHide = this.toHide.add(this.containers)), this.showErrors(), i },
                ...
                elements: function() {
                    var e = this,
                        i = {};
                    return t(this.currentForm).find("input, select, textarea").not(":submit, :reset, :image, [disabled]").not(this.settings.ignore).filter((function() { return !this.name && e.settings.debug && window.console && console.error("%o has no name assigned", this), !(this.name in i || !e.objectLength(t(this).rules())) && (i[this.name] = !0, !0) }))
                },
                ...
                check: function(e) {
                    ...
                    for (var a in s) { var u = { method: a, parameters: s[a] }; try { if ("dependency-mismatch" === (i = t.validator.methods[a].call(this, n, e, u.parameters))) { r = !0; continue } if (r = !1, "pending" === i) return void(this.toHide = this.toHide.not(this.errorsFor(e))); if (!i) return this.formatAndAdd(e, u), !1 } catch (o) { throw this.settings.debug && window.console && console.log("Exception occurred when checking element " + e.id + ", check the '" + u.method + "' method.", o), o } }
            ...
            attributeRules: function(e) {
                ...
                for (var n in t.validator.methods) { var a; "required" === n ? ("" === (a = s.get(0).getAttribute(n)) && (a = !0), a = !!a) : a = s.attr(n), /min|max/.test(n) && (null === r || /number|range|text/.test(r)) && (a = Number(a)), a ? i[n] = a : r === n && "range" !== r && (i[n] = !0) }
    ...
    function(t) { t.extend(t.fn, { validateDelegate: function(e, i, s) { return this.bind(i, (function(i) { var r = t(i.target); return r.is(e) ? s.apply(r, arguments) : void 0 })) } }) }(jQuery), jQuery((function($) {
        function successForm(obj) {
            var objMessage = $(obj).find(".tt-modal-message");
            objMessage.addClass("tt-active"), setTimeout((function() { objMessage.removeClass("tt-active") }), 3600)
        }
        var formContactForm = $("#feedbackform");
        formContactForm.length && formContactForm.validate({ rules: { name: { required: !0, minlength: 2 }, email: { required: !0, email: !0 }, message: { required: !0 } }, messages: { name: { required: "Please enter your name", minlength: "Your name must consist of at least 2 characters" }, email: { required: "Please enter your email" }, message: { required: "Please enter your message" } }, submitHandler: function(form) { $(form).ajaxSubmit({ type: "POST", data: $(form).serialize(), url: "external/form/contact-form.php", success: function() { $("#success").fadeIn(), formContactForm.each((function() { this.reset() })), successForm(formContactForm) }, error: function() { formContactForm.fadeTo("slow", 1, (function() { $("#error").fadeIn() })) } }) } });
        var subscribeform = $("#subscribeform");
        subscribeform.length && subscribeform.validate({ rules: { email: { required: !0, email: !0 } }, submitHandler: function(form) { $(form).ajaxSubmit({ type: "POST", data: $(form).serialize(), url: "external/form/newsletter-form.php", success: function() { $("#success").fadeIn(), subscribeform.each((function() { this.reset() })), successForm(subscribeform) }, error: function() { subscribeform.fadeTo("slow", 1, (function() { $("#error").fadeIn() })) } }) } });
        var formjsFormMakeAppointment = $("#jsFormMakeAppointment");
        formjsFormMakeAppointment.length && formjsFormMakeAppointment.validate({
            rules: { name: { required: !0, minlength: 2 }, email: { required: !0, email: !0 }, message: { required: !0 } },
            messages: { name: { required: "Please enter your name", minlength: "Your name must consist of at least 2 characters" }, email: { required: "Please enter your email" }, message: { required: "Please enter your message" } },
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    ...
                    success: function() {
                        $("#success").fadeIn(), formjsFormMakeAppointment.each((function() { this.reset() })),
                            function successModal() {
                                if ($("body").hasClass("modal-open")) {
                                    var objModal = $(".modal");
                                    if (!objModal.hasClass("show")) return !1;
                                    objModal.find(".tt-modal-message").addClass("tt-active"), setTimeout((function() { objModal.find(".close").trigger("click"), objModal.find(".tt-modal-message").removeClass("tt-active") }), 1600)
                                }
                            }()
                    },
                    error: function() { formjsFormMakeAppointment.fadeTo("slow", 1, (function() { $("#error").fadeIn() })) }
                })
            }
        });
        var blogCommentForm = $("#feedbackComment");
        blogCommentForm.length && blogCommentForm.validate({ rules: { name: { required: !0, minlength: 2 }, email: { required: !0, email: !0 }, message: { required: !0 } }, messages: { name: { required: "Please enter your name", minlength: "Your name must consist of at least 2 characters" }, email: { required: "Please enter your email" }, message: { required: "Please enter your message" } }, submitHandler: function(form) { $(form).ajaxSubmit({ type: "POST", data: $(form).serialize(), url: "external/form/comment-form.php", success: function() { $("#success").fadeIn(), blogCommentForm.each((function() { this.reset() })), successForm(blogCommentForm) }, error: function() { blogCommentForm.fadeTo("slow", 1, (function() { $("#error").fadeIn() })) } }) } });
        ...
        orderForm.length && orderForm.validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    ...
                    success: function() {
                        $("#success").fadeIn(), orderForm.each((function() { this.reset() })),
                            function successForm1(obj) {
                                var objMessage = $(obj).next(".tt-modal-message");
                                objMessage.addClass("tt-active"), setTimeout((function() { objMessage.removeClass("tt-active") }), 3600)
                            }(orderForm)
                    },
                    error: function() { orderForm.fadeTo("slow", 1, (function() { $("#error").fadeIn() })) }
                })
            }
        })
    })),
    function($) {
        ...
        mobileProduct.length && mobileProduct.slick({ dots: !0, arrows: !1, infinite: !0, speed: 300, slidesToShow: 1, adaptiveHeight: !0, lazyLoad: "progressive" }), {
            scroll_zoom: !0,
            class_name: ".zoom-product",
            thumb_parent: $("#smallGallery"),
            scrollslider_parent: $(".slider-scroll-product"),
            checkNoZoom: function() { return $(this.class_name).parent().parent().hasClass("no-zoom") },
            init: function(type) {
                var _ = this,
            ...
            configureZoomImage: function() {
                ...
                })), setTimeout((function() { $(_.class_name).elevateZoom({ gallery: _.thumb_parent.attr("id"), zoomType: "inner", scrollZoom: Boolean(_.scroll_zoom), cursor: "crosshair", zoomWindowFadeIn: 300, zoomWindowFadeOut: 300 }) }), 100)
            },
            resize: function() {
                var _ = this;
                $(window).resize((function() {
            ...
            horizontal: function(_parent) { _parent.slick({ infinite: !0, dots: !1, arrows: !0, slidesToShow: 4, slidesToScroll: 1, nextArrow: '<a href="#" class="tt-custom-next"><i class="tt-icon icon-arrowhead-pointing-to-the-right-1"></i><span class="tt-text">more</span></button>', responsive: [{ breakpoint: 1024, settings: { slidesToShow: 3 } }, { breakpoint: 767, settings: { slidesToShow: 2 } }] }) },
            vertical: function(_parent) { _parent.slick({ vertical: !0, infinite: !0, slidesToShow: 4, slidesToScroll: 1, verticalSwiping: !0, arrows: !0, dots: !1, centerPadding: "0px", customPaging: "0px", responsive: [{ breakpoint: 1200, settings: { slidesToShow: 5, slidesToScroll: 1 } }, { breakpoint: 992, settings: { slidesToShow: 5, slidesToScroll: 1 } }, { breakpoint: 768, settings: { slidesToShow: 5, slidesToScroll: 1 } }] }) },
            initBigGalleryButtons: function() {
                var bigGallery = $(".bigGallery");
                if (0 == bigGallery.length) return !1;
                $("body").on("mouseenter", ".zoomContainer", (function() { bigGallery.find("button").addClass("show") })).on("mouseleave", ".zoomContainer", (function() { bigGallery.find("button").removeClass("show") }))
            },
            scrollSlider: function() {
                var _scrollslider_parent = this.scrollslider_parent;
                if (0 == _scrollslider_parent.length) return !1;
                _scrollslider_parent.on("init", (function(event, slick) { _scrollslider_parent.css({ opacity: 1 }) })), _scrollslider_parent.css({ opacity: 0 }).slick({ infinite: !1, vertical: !0, verticalScrolling: !0, dots: !0, arrows: !1, slidesToShow: 1, slidesToScroll: 1, responsive: [{ breakpoint: 1200, settings: { slidesToShow: 1, slidesToScroll: 1 } }, { breakpoint: 992, settings: { slidesToShow: 1, slidesToScroll: 1 } }, { breakpoint: 768, settings: { slidesToShow: 1, slidesToScroll: 1 } }] }).mousewheel((function(e) { e.preventDefault(), e.deltaY < 0 ? $(this).slick("slickNext") : $(this).slick("slickPrev") }))
            },
        ...
        })).on("keypress", (function(e) { 13 === e.keyCode && e.preventDefault() })))
    }(jQuery),
    function($) {
        var methods = {
            init: function(options) {
                return this.each((function() {
                    ...
                    objOpen.find(".tt-item__content").slideToggle(100), objItemTitle.on("click", (function() { $(this).parent().hasClass("tt-item__open") || $(this).parent().siblings().removeClass("tt-item__open").find(".tt-item__content").slideUp(200), $(this).next().slideToggle(200).parent().toggleClass("tt-item__open") }))
                }))
            }
        };
        $.fn.accordeon = function(action) { return methods[action] ? methods[action].apply(this, Array.prototype.slice.call(arguments, 1)) : "object" != typeof action && action ? (console.info("Action " + action + "not found this plugin"), this) : methods.init.apply(this, arguments) }, $("#tt-pageContent .js-accordeon").accordeon()
    }(jQuery),
    function($) {
        var ptBackToTop = $("#js-backtotop"),
            $window = $(window);
        ptBackToTop.length && function initbacktotop() { $window.scroll((function() { $window.scrollTop() > 500 ? ptBackToTop.stop((!0).false).addClass("pt-show") : ptBackToTop.stop((!0).false).removeClass("pt-show") })) }()
    }(jQuery),
    function($) {
        var u, is, $html = jQuery("html");
        u = navigator.userAgent.toLowerCase(), is = function(t) { return -1 != u.indexOf(t) }, $html.addClass([!/opera|webtv/i.test(u) && /msie (\d)/.test(u) ? "ie ie" + RegExp.$1 : is("firefox/2") ? "gecko ff2" : is("firefox/3") ? "gecko ff3" : is("gecko/") ? "gecko" : is("opera/9") ? "opera opera9" : /opera (\d)/.test(u) ? "opera opera" + RegExp.$1 : is("konqueror") ? "konqueror" : is("applewebkit/") ? "webkit safari" : is("mozilla/") ? "gecko" : "", is("x11") || is("linux") ? " linux" : is("mac") ? " mac" : is("win") ? " win" : ""].join(""));
        (function is_touch_device() { return !!("ontouchstart" in window) || !!("onmsgesturechange" in window) })() && $html.addClass("touch-device"), /Edge/.test(navigator.userAgent) && $html.addClass("edge")
    }(),
    function($) {
        var nav = $("#tt-nav");
        if (!nav.length) return !1;
        var cur_url;
        nav.find("> ul > li").each((function() { 0 != $(this).children("ul").length && $(this).addClass("subMenu") })), cur_url = window.location.href.split("#")[0].split("/").pop() || "index.html", nav.find("li").each((function() {
            var link = $(this).find("a").attr("href");
            cur_url == link && ($(this).addClass("active").closest(".subMenu").addClass("active"), nav.addClass("defined-item"))
        })), nav.hasClass("defined-item") || nav.find("> ul > li:first-child").addClass("active"), nav.find("li").on("mouseenter mouseleave", (function(event) { $(this).toggleClass("is-hover") }))
    }(jQuery),
    function($) {
        if (!$("#tt-header .js-dropdown-cart").length) return !1;

        function closeDropdown() { $("#tt-header .js-dropdown-cart").each((function() { $(this).removeClass("active"), setTimeout((function() { $("#tt-header .js-dropdown-cart").find(".tt-obj__dropdown").children().remove() }), 200) })) }
        ...
        })), $("body").on("click touchstart", ".js-dropdown-cart .tt-obj__dropdown-close", (function(e) { closeDropdown() })), $(document).mouseup((function(e) {
            var div = $("#tt-header .js-dropdown-cart");
            div.is(e.target) || 0 !== div.has(e.target).length || closeDropdown()
        })), $(window).resize(debouncer((function(e) { closeDropdown() })))
    }(jQuery),
    function($) {
    ...
    }(jQuery), jQuery("#tt-pageContent [data-slick]").slick({ lazyLoad: "progressive", dots: !0, arrows: !1, infinite: !0, speed: 300, autoplay: !0, adaptiveHeight: !0, slidesToScroll: 1, pauseOnFocus: !1, pauseOnHover: !1 }),
    function($) {
        function initSliderCarusel() {
            var slick04 = $("#tt-pageContent .js-init-carusel-04"),
                width = window.innerWidth || document.body.clientWidth;
            if (!slick04.length) return !1;
            width <= 1024 ? slick04.slick({ lazyLoad: "progressive", dots: !0, arrows: !1, infinite: !0, speed: 300, slidesToShow: 1, slidesToScroll: 1, adaptiveHeight: !0, autoplay: !0, autoplaySpeed: 4500, pauseOnFocus: !1, pauseOnHover: !1 }) : slick04.filter(".slick-initialized").slick("unslick")
        }
        initSliderCarusel(), $(window).resize(debouncer((function(e) { initSliderCarusel() })))
    }(jQuery),
    function($) {
        function initSliderCarusel() {
            ...
            width <= 1024 ? slick05.slick({ lazyLoad: "progressive", dots: !0, arrows: !1, infinite: !0, speed: 300, slidesToShow: 5, slidesToScroll: 1, adaptiveHeight: !0, autoplay: !0, autoplaySpeed: 2e3, pauseOnFocus: !1, pauseOnHover: !1, responsive: [{ breakpoint: 767, settings: { slidesToShow: 3, slidesToScroll: 1 } }, { breakpoint: 576, settings: { slidesToShow: 2, slidesToScroll: 2 } }] }) : slick05.filter(".slick-initialized").slick("unslick")
        }
        initSliderCarusel(), $(window).resize(debouncer((function(e) { initSliderCarusel() })))
    }(jQuery),
    function($) {
        if (!$("#tt-pageContent .tt-slideinfo").length) return !1;
        $("#tt-pageContent .tt-slideinfo").on("mouseenter", (function() { $(this).addClass("wide active").siblings().addClass("short") })).on("mouseleave", (function() { $(this).removeClass("active").siblings().removeClass("short") })), $("body").on("click touchstart", ".tt-slideinfo .tt-item__btn > *", (function(e) { var obj = $(this); return $(this).closest(".tt-slideinfo").hasClass("open-info") ? function closeLayout(obj) { obj.html("+"), obj.closest(".tt-slideinfo").removeClass("open-info") }(obj) : function openLayout(obj) { obj.html("-"), obj.closest(".tt-slideinfo").siblings().removeClass("open-info").find(".tt-item__btn  > *").html("+"), obj.closest(".tt-slideinfo").addClass("open-info") }(obj), !1 }));

        function initSliderCarusel() {
            var slickCarusel = $("#tt-pageContent .tt-slideinfo-wrapper"),
                width = window.innerWidth || document.body.clientWidth;
            if (!slickCarusel.length) return !1;
            width <= 767 ? slickCarusel.slick({ dots: !0, arrows: !1, infinite: !0, speed: 300, slidesToShow: 2, slidesToScroll: 1, adaptiveHeight: !0, autoplay: !0, autoplaySpeed: 2e3, responsive: [{ breakpoint: 576, settings: { slidesToShow: 1, slidesToScroll: 1 } }] }) : slickCarusel.filter(".slick-initialized").slick("unslick")
        }
        initSliderCarusel(), $(window).resize(debouncer((function(e) { initSliderCarusel() })))
    }(jQuery),
    function($) {
        ...
        $("#modalMakeAppointment .js_datepicker-1").datepicker({ language: "en" }).data("datepicker"), $("#orderform .datepicker-1").datepicker({ language: "en" }).data("datepicker")
    }(jQuery),
    function($) {
        ...
        if ($ttDesctopMenu && mobileMenuToggle) {
            ...
            $("#mobile-menu").find("ul").append(ttDesktopMenu), mobileMenuToggle.initMM({ enable_breakpoint: !0, mobile_button: !0, breakpoint: 1025 })
        }
    }(jQuery),
    function($) {
        var videoPopup = $("#tt-pageContent .js-video-popup");
        videoPopup.length && videoPopup.each((function() { $(this).magnificPopup({ type: "iframe", iframe: { patterns: { dailymotion: { index: "dailymotion.com", id: function(url) { var m = url.match(/^.+dailymotion.com\/(video|hub)\/([^_]+)[^#]*(#video=([^_&]+))?/); return null !== m ? void 0 !== m[4] ? m[4] : m[2] : null }, src: "https://www.dailymotion.com/embed/video/%id%" } } } }) }))
    }(jQuery), jQuery("#tt-pageContent .js-wrapper-gallery").magnificPopup({ delegate: ".tt-gallery", type: "image", gallery: { enabled: !0 } }),
    function($) {
        function calcHeight() {
            if ((window.innerWidth || $(window).width()) <= 786) return $("#tt-pageContent .layout01").each((function() { $(this).find(".layout01__content-wrapper").removeAttr("style") })), !1;
        ...
        $(window).on("load", (function() { calcHeight() })), $(window).resize(debouncer((function(e) { calcHeight() })))
...
window.onload = function() {
    ...
    function($) {
        ...
        function initStuck() { $window.scrollTop() > 0 ? header.addClass("stuck") : header.removeClass("stuck") }
        header.length && (! function stuck() { $window.scroll((function() { initStuck() })) }(), initStuck())
    }(jQuery),
    function($) {
        if (!$("#js-toggle-h-holder").length) return !1;
        $("body").on("click", "#js-toggle-h-holder", (function(e) { return $(this).toggleClass("active").prev().slideToggle(300), !1 }))
    }(jQuery),
    function($) {
        if (!$("#js-toggle-orderform").length) return !1;
        $("body").on("click", "#js-toggle-orderform", (function(e) { return $(this).toggleClass("active").next().slideToggle(300), !1 }))
    }(jQuery);