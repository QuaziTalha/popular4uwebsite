...
function mm_destroy(_parent, mmpanel) {
  mmpanel.remember_state ||
    ...
    _parent.toggleClass("mmhide mmitemopen", !1).hide(),
...
function getButtonBack(value, _default) {
  return (
    ...
    (value = null == value ? _default : value) +
    "</a></li>"
  );
}
...
$("body").append(getFullscreenBg()),
  ($.fn.initMM = function () {
    var mmpanel = {
      ...
      init: function ($button, data) {
        ...
        null != arguments[1] && _this.parse_arguments(data),
          _this.$mobilemenu.parse_mm(mmpanel),
          _this.$mobilemenu.init_mm(mmpanel),
          _this.mm_enable_breakpoint &&
            _this.$mobilemenu.check_resolution_mm(mmpanel),
          $button.mm_handler(mmpanel);
      },
      parse_arguments: function (data) {
        var _this = this;
        Object(data).hasOwnProperty("menu_class") &&
          (_this.$mobilemenu = $("." + data.menu_class)),
      ...
      show_button_in_mobile: function ($button) {
        var _this = this;
        _this.mm_mobile_button &&
          (window.innerWidth > _this.mm_breakpoint
            ? $button.hide()
            : $button.show(),
  ...
  ($.fn.check_resolution_mm = function (mmpanel) {
    var _this = $(this);
    $(window).resize(function () {
      if (!$("body").hasClass("mm-open") || !_this.hasClass("mmitemopen"))
        return !1;
  ...
  ($.fn.parse_mm = function (mmpanel) {
    ...
    $(this).empty(),
      $mm_curent.find("a").each(function () {
        (_this = $(this)),
          ($ul = _this.parent().find("ul").first()).length &&
            (count++,
            $ul
              .prepend("<li></li>")
              .find("li")
        ...
        ($btnBack = !1),
          ...
          0 == index
            ? ($mm_block
                ...
                .addClass("mmcurrent")
                .removeClass("mmhidden"),
              ($btnBack = getButtonClose(
                $mm_curent.find(".mm-closebtn").html(),
                mmpanel.mm_close_button
              )),
              $mm_block.find("ul").first().prepend($btnBack))
            : (($btnBack = getButtonBack(
                $mm_curent.find(".mm-backbtn").html(),
                mmpanel.mm_back_button
              )),
              $mm_block.find("ul").first().prepend($btnBack)),
    ...
    _parent.find("a").each(function () {
      $(this).click(function (e) {
        var _this = $(this),
          $currobj = !1,
          lv = "";
        return _this.hasClass("mm-next-level")
          ? (e.preventDefault(),
            (lv = _this.attr("href")),
          ...
          ? (e.preventDefault(),
            ...
            !1)
          : _this.hasClass("mm-close")
          ? (_parent.closemm(mmpanel), !1)
          : void 0;
      });
    }),
    ...
    (o = "datepicker"),
      ...
      ((n = m).prototype = {
        ...
        formatDate: function (t, e) {
          ...
          switch (
            (this.opts.timepicker &&
              ...
              u &&
              ((d = o(
                (i = this.timepicker._getValidHoursFromDate(e, u)).hours
              )),
              (l = i.hours),
              (m = i.dayPeriod)),
            !0)
        ...
        _getCell: function (t, i) {
          ...
          return (s = this.views[this.currentView].$el.find(h)).length
            ? s
            : e("");
        },
        destroy: function () {
        ...
        _onMouseLeaveCell: function (t) {
          e(t.target).closest(".datepicker--cell").removeClass("-focus-"),
            (this.silent = !0),
            (this.focused = ""),
            (this.silent = !1);
        },
        _onTimeChange: function (t, e, i) {
          var s = new Date(),
            n = !1;
          this.selectedDates.length && ((n = !0), (s = this.lastSelectedDate)),
            s.setHours(e),
            s.setMinutes(i),
        ...
        (s.Body = function (t, i, s) {
          ...
          (s.Body.prototype = {
            ...
            _getCellContents: function (t, e) {
              ...
              return (
                r.onRenderCell &&
                  ((l = (d = r.onRenderCell(t, e) || {}).html ? d.html : l),
        ...
        (a.Navigation = function (t, e) {
          ...
          (a.Navigation.prototype = {
            ...
            _render: function () {
              ...
              this.d.$nav.html(s),
                "years" == this.d.view &&
                  e(".datepicker--nav-title", this.d.$nav).addClass(
                    "-disabled-"
                  ),
                this.setNavStatus();
            },
        ...
        (i.Timepicker = function (t, e) {
          ...
          (i.Timepicker.prototype = {
            ...
            _setTime: function (t) {
              ...
              this._handleDate(t),
                (this.hours =
                  e.hours < this.minHours ? this.minHours : e.hours),
                (this.minutes =
            ...
            _setDefaultMinMaxTime: function () {
              var i = this.opts;
              (this.minHours =
                i.minHours < 0 || i.minHours > 23 ? 0 : i.minHours),
                (this.minMinutes =
                  i.minMinutes < 0 || i.minMinutes > 59 ? 0 : i.minMinutes),
                (this.maxHours =
                  i.maxHours < 0 || i.maxHours > 23 ? 23 : i.maxHours),
                (this.maxMinutes =
                  i.maxMinutes < 0 || i.maxMinutes > 59 ? 59 : i.maxMinutes);
            },
  ...
  })(
    {
            ...
            jQuery.fn.perfectScrollbar = function (settingOrCommand) {
              return this.each(function () {
                if (
                  ...
                  "update" === command
                    ? ps.update(this)
                    : "destroy" === command && ps.destroy(this);
                }
                return jQuery(this);
              });
            };
          ...
          (exports.add = function (element, className) {
            element.classList
              ...
              : (function oldAdd(element, className) {
                  ...
                  classes.indexOf(className) < 0 && classes.push(className),
            ...
            (DOM.css = function (element, styleNameOrObject, styleValue) {
              return "object" == typeof styleNameOrObject
                ? (function cssMultiSet(element, obj) {
                    for (var key in obj) {
                      var val = obj[key];
                      "number" == typeof val && (val = val.toString() + "px"),
                        (element.style[key] = val);
                    }
                    return element;
                  })(element, styleNameOrObject)
                : void 0 === styleValue
      ...
      4: [
        function (require, module, exports) {
          ...
          (EventElement.prototype.bind = function (eventName, handler) {
            void 0 === this.events[eventName] && (this.events[eventName] = []),
            ...
            (EventElement.prototype.unbind = function (eventName, handler) {
              ...
              this.events[eventName] = this.events[eventName].filter(function (
                ...
                return (
                  ...
                  (this.element.removeEventListener(eventName, hdlr, !1), !1)
                );
              },
              this);
            }),
            ...
            (exports.startScrolling = function (element, axis) {
              cls.add(element, "ps-in-scrolling"),
                void 0 !== axis
                  ...
                  : (cls.add(element, "ps-x"), cls.add(element, "ps-y"));
            }),
            (exports.stopScrolling = function (element, axis) {
              cls.remove(element, "ps-in-scrolling"),
                void 0 !== axis
                  ? cls.remove(element, "ps-" + axis)
                  : (cls.remove(element, "ps-x"), cls.remove(element, "ps-y"));
            }),
            (exports.env = {
                ...
                !(function updateScrollLeft(deltaX) {
                  var newLeft = currentLeft + deltaX * i.railXRatio,
                    maxLeft =
                      ...
                      i.railXRatio * (i.railXWidth - i.scrollbarXWidth);
                  i.scrollbarXLeft =
                    newLeft < 0 ? 0 : newLeft > maxLeft ? maxLeft : newLeft;
                  var scrollLeft =
                    h.toInt(
                ...
                !(function updateScrollTop(deltaY) {
                  var newTop = currentTop + deltaY * i.railYRatio,
                    maxTop =
                      ...
                      i.railYRatio * (i.railYHeight - i.scrollbarYHeight);
                  i.scrollbarYTop =
                    newTop < 0 ? 0 : newTop > maxTop ? maxTop : newTop;
              ...
              if (!e.isDefaultPrevented || !e.isDefaultPrevented()) {
                ...
                if (hovered || focused) {
                  ...
                  updateScroll(element, "top", element.scrollTop - deltaY),
                    ...
                    updateGeometry(element),
                    (shouldPrevent = (function shouldPreventDefault(
                      deltaX,
                      deltaY
                    ) {
              ...
              (function shouldBeConsumedByTextarea(deltaX, deltaY) {
                ...
                if (hoveredTextarea) {
                  ...
                  if (
                    maxScrollTop > 0 &&
                    !(
                      (0 === hoveredTextarea.scrollTop && deltaY > 0) ||
                  ...
                  if (
                    maxScrollLeft > 0 &&
                    !(
                      (0 === hoveredTextarea.scrollLeft && deltaX < 0) ||
                      (hoveredTextarea.scrollLeft === maxScrollLeft &&
                        deltaX > 0)
                    )
                  )
                    return !0;
                ...
                shouldPrevent && (e.stopPropagation(), e.preventDefault()));
            }
        ...
        function (require, module, exports) {
          ...
          function bindSelectionHandler(element, i) {
            ...
            function stopScrolling() {
              scrollingLoop &&
                (clearInterval(scrollingLoop), (scrollingLoop = null)),
              ...
              i.event.bind(window, "mousemove", function (e) {
                if (isSelected) {
                  ...
                  mousePosition.x < containerGeometry.left + 3
                    ? ((scrollDiff.left = -5), h.startScrolling(element, "x"))
                    : mousePosition.x > containerGeometry.right - 3
                    ? ((scrollDiff.left = 5), h.startScrolling(element, "x"))
                    : (scrollDiff.left = 0),
                    mousePosition.y < containerGeometry.top + 3
                      ? ((scrollDiff.top =
                          containerGeometry.top + 3 - mousePosition.y < 5
                            ? -5
                            : -20),
                        h.startScrolling(element, "y"))
                      : mousePosition.y > containerGeometry.bottom - 3
                      ? ((scrollDiff.top =
                          mousePosition.y - containerGeometry.bottom + 3 < 5
                            ? 5
                            : 20),
                        h.startScrolling(element, "y"))
                      : (scrollDiff.top = 0),
                    0 === scrollDiff.top && 0 === scrollDiff.left
                      ? stopScrolling()
      ...
      17: [
        function (require, module, exports) {
          ...
          module.exports = function (element, userSettings) {
            (userSettings =
              "object" == typeof userSettings ? userSettings : {}),
            ...
            (i.settings = h.extend(i.settings, userSettings)),
              ...
              i.settings.useSelectionScroll && selectionHandler(element),
              (h.env.supportsTouch || h.env.supportsIePointer) &&
                touchHandler(
                  element,
                  h.env.supportsTouch,
                  h.env.supportsIePointer
                ),
              i.settings.useKeyboard && keyboardHandler(element),
              updateGeometry(element);
          };
        },
        {
        ...
        function (require, module, exports) {
          ...
          function Instance(element) {
            ...
            (i.settings = h.clone(defaultSettings)),
              ...
              (i.isRtl = "rtl" === d.css(element, "direction")),
              (i.isNegativeScroll =
          ...
          function getId(element) {
            return void 0 === element.dataset
              ? element.getAttribute("data-ps-id")
              : element.dataset.psId;
          }
          (exports.add = function (element) {
            var newId = guid();
            return (
              (function setId(element, id) {
                void 0 === element.dataset
      ...
      20: [
        function (require, module, exports) {
          ...
          upEvent.initEvent("ps-scroll-up", !0, !0),
            downEvent.initEvent("ps-scroll-down", !0, !0),
            leftEvent.initEvent("ps-scroll-left", !0, !0),
            rightEvent.initEvent("ps-scroll-right", !0, !0),
            yEvent.initEvent("ps-scroll-y", !0, !0),
            xEvent.initEvent("ps-scroll-x", !0, !0),
            xStartEvent.initEvent("ps-x-reach-start", !0, !0),
            xEndEvent.initEvent("ps-x-reach-end", !0, !0),
            yStartEvent.initEvent("ps-y-reach-start", !0, !0),
            yEndEvent.initEvent("ps-y-reach-end", !0, !0),
            ...
            b.zoomContainer
              ...
              .bind(
                ...
                function (a) {
                  ...
                  var e =
                    a.originalEvent.wheelDelta || -1 * a.originalEvent.detail;
                  return (
                    a.stopImmediatePropagation(),
                    a.stopPropagation(),
                    a.preventDefault(),
      ...
      setWindowPostition: function (b) {
        ...
        (a.isWindowSet = !0),
          ...
          a.Eboppos &&
            (a.windowTopPos =
              -1 *
              (a.largeHeight / a.currentZoomLevel - a.zoomWindow.height())),
          a.Eroppos &&
            (a.windowLeftPos =
              -1 * (a.largeWidth / a.currentZoomLevel - a.zoomWindow.width())),
          a.fullheight && (a.windowTopPos = 0),
          a.fullwidth && (a.windowLeftPos = 0),
          ("window" != a.options.zoomType && "inner" != a.options.zoomType) ||
            (1 == a.zoomLock &&
                ...
                a.loop ||
                  (a.loop = setInterval(function () {
                    (a.xp += (a.windowLeftPos - a.xp) / a.options.easingAmount),
                      (a.yp +=
                        (a.windowTopPos - a.yp) / a.options.easingAmount),
                      a.scrollingLock
  ...
  (function (t, e) {
    ...
    var o,
          ...
          return (
            ...
            (e._getRootElement = function (t) {
              var e = P.getSelectorFromElement(t),
                n = !1;
              return (
                e && (n = o(e)[0]), n || (n = o(t).closest(".alert")[0]), n
              );
            }),
            ...
            (e._removeElement = function (t) {
              ...
              o(t).removeClass("show"),
                P.supportsTransitionEnd() && o(t).hasClass("fade")
                  ? o(t)
      ...
      R =
        ...
        p(document)
          .on(O.CLICK_DATA_API, b, function (t) {
            t.preventDefault();
            var e = t.target;
            p(e).hasClass("btn") || (e = p(e).closest(N)),
        ...
        var e = "carousel",
          ...
          C = (function () {
            ...
            return (
              ...
              (C.pause = function (e) {
                e || (this._isPaused = !0),
                  t(this._element).find(y_NEXT_PREV)[0] &&
              ...
              (C._getItemIndex = function (e) {
                return (
                  (this._items = t.makeArray(t(e).parent().find(y_ITEM))),
              ...
              (C._triggerSlideEvent = function (e, n) {
                var i = this._getItemIndex(e),
                  s = this._getItemIndex(
                    t(this._element).find(y_ACTIVE_ITEM)[0]
                  ),
                  r = t.Event(d.SLIDE, {
                    relatedTarget: e,
                    direction: n,
      ...
      H = (function (t) {
        ...
        return (
          t(document).on(h.CLICK_DATA_API, p_DATA_TOGGLE, function (e) {
      ...
      M = (function (t) {
        var n = "bs.modal",
          ...
          p = (function () {
            function o(e, n) {
              (this._config = this._getConfig(n)),
                (this._element = e),
                (this._dialog = t(e).find(g_DIALOG)[0]),
                (this._backdrop = null),
                (this._isShown = !1),
            ...
            return (
              ...
              (p._resetScrollbar = function () {
                t(g_FIXED_CONTENT).each(function (e, n) {
                  ...
                  t(g_STICKY_CONTENT + ", " + g_NAVBAR_TOGGLER).each(function (
                    e,
                    n
                  ) {
        ...
        return (
          t(document).on(h.CLICK_DATA_API, g_DATA_TOGGLE, function (e) {
            var i,
              s = this,
            ...
            return (
              ...
              (g._activate = function (e) {
                ...
                i.hasClass("dropdown-item")
                  ? (i.closest(f_DROPDOWN).find(f_DROPDOWN_TOGGLE).addClass(u),
                    i.addClass(u))
                  : (i.addClass(u),
                    i
                      .parents(f_NAV_LIST_GROUP)
                      .prev(f_NAV_LINKS + ", " + f_LIST_ITEMS)
                      .addClass(u),
                    i
                      .parents(f_NAV_LIST_GROUP)
                      .prev(f_NAV_ITEMS)
                      .children(f_NAV_LINKS)
                      .addClass(u)),
            ...
            return (
              ...
              (i._transitionComplete = function (e, n, i) {
                ...
                if (
                  ...
                  r && t(r).find(".dropdown-toggle").addClass(a),
    ...
    var t = (function (u, D, f) {
      ...
      var O = D.documentElement,
        ...
        s = function (e, t, a) {
          for (
            a = a || e.offsetWidth;
            a < H.minSize && t && !e._lazysizesWidth;
        ...
        ee = (function () {
          var a,
            ...
            s = function () {
              var e = n;
              for (n = t.length ? r : t, a = !0, i = !1; e.length; )
                e.shift()();
              a = !1;
            },
            e = function (e, t) {
    ...
    ($.fn.attr2 = function () {
      ...
      ($.fn.ajaxSubmit = function (options) {
        ...
        "function" == typeof options && (options = { success: options }),
          ...
          (url =
            (url =
              "string" == typeof (action = this.attr2("action"))
                ? $.trim(action)
                : "") ||
        ...
        if (
          ...
          !1 === options.beforeSerialize(this, options)
        )
          return (
        ...
        if (
          ...
          options.beforeSubmit && !1 === options.beforeSubmit(a, this, options))
        )
          return (
        ...
        var hasFileInputs =
            $('input[type=file]:enabled[value!=""]', this).length > 0,
        ...
        !1 !== options.iframe && (options.iframe || shouldUseFrame)
        ...
        function fileUploadIframe(a) {
          ...
          if (
            (((s = $.extend(!0, {}, $.ajaxSettings, options)).context =
              s.context || s),
            (id = "jqFormIO" + new Date().getTime()),
            s.iframeTarget
              ? (n = ($io = $(s.iframeTarget)).attr2("name"))
                ? (id = n)
                : $io.attr2("name", id)
              : ($io = $(
            ...
            (g = s.global) && 0 == $.active++ && $.event.trigger("ajaxStart"),
            g && $.event.trigger("ajaxSend", [xhr, s]),
            s.beforeSend && !1 === s.beforeSend.call(s.context, xhr, s))
          )
          ...
          function cb(e) {
            if (!xhr.aborted && !callbackProcessed) {
              if (
                ((doc = getDoc(io)) ||
                  (log("cannot access response document"), (e = 2)),
                1 === e && xhr)
              )
                return (
                  xhr.abort("timeout"), void deferred.reject(xhr, "timeout")
                );
              if (2 == e && xhr)
                return (
                  xhr.abort("server abort"),
                  void deferred.reject(xhr, "error", "server abort")
                );
                ...
                try {
                  ...
                  (xhr.responseText = docRoot ? docRoot.innerHTML : null),
                    ...
                    (xhr.getResponseHeader = function (header) {
                      return { "content-type": s.dataType }[header];
                    }),
                    docRoot &&
                      ((xhr.status =
              ...
              function (s, doc) {
                return (
                  window.ActiveXObject
                    ? (((doc = new ActiveXObject("Microsoft.XMLDOM")).async =
                        "false"),
                      doc.loadXML(s))
      ...
      t.extend(t.validator, {
        ...
        attributeRules: function (e) {
          ...
          for (var n in t.validator.methods) {
            var a;
            "required" === n
              ? ("" === (a = s.get(0).getAttribute(n)) && (a = !0), (a = !!a))
              : (a = s.attr(n)),
              /min|max/.test(n) &&
        ...
        dataRules: function (e) {
          ...
          for (i in t.validator.methods)
            void 0 !== (s = n.data("rule-" + i.toLowerCase())) && (r[i] = s);
          return r;
        },
  ...
  jQuery(function ($) {
    ...
    formjsFormMakeAppointment.length &&
                    ...
                    objModal.find(".tt-modal-message").addClass("tt-active"),
                      setTimeout(function () {
                        objModal.find(".close").trigger("click"),
                          objModal
                            .find(".tt-modal-message")
                            .removeClass("tt-active");
                      }, 1600);
                  }
                })();
            },
      ...
      }),
      {
        ...
        init: function (type) {
          ...
          if (!_.checkNoZoom()) {
            ...
            (attr_scroll = attr_scroll || _.scroll_zoom),
              (_.scroll_zoom = "false" != attr_scroll),
        ...
        horizontal: function (_parent) {
          _parent.slick({
            ...
            slidesToScroll: 1,
            nextArrow:
              '<a href="#" class="tt-custom-next"><i class="tt-icon icon-arrowhead-pointing-to-the-right-1"></i><span class="tt-text">more</span></button>',
            responsive: [
        ...
        setBigImage: function (_parent) {
          ...
          _parent.find("a").on("click", function (e) {
            ...
            if ((zoom_image.attr(setParam, big_image), !_.checkNoZoom()))
              return !1;
      ...
      (inputCounter.find(".minus-btn, .plus-btn").on("click", function (e) {
        var $input = $(this).parent().find("input"),
          count =
            ...
            parseInt("plus-btn" === e.currentTarget.className ? 1 : -1, 10);
  ...
  (function ($) {
        ...
        return this.each(function () {
          ...
          objOpen.find(".tt-item__content").slideToggle(100),
            objItemTitle.on("click", function () {
              $(this).parent().hasClass("tt-item__open") ||
                $(this)
                  .parent()
                  .siblings()
                  .removeClass("tt-item__open")
                  .find(".tt-item__content")
                  .slideUp(200),
                $(this)
                  .next()
                  .slideToggle(200)
                  .parent()
                  .toggleClass("tt-item__open");
            });
        });
      },
    };
    ($.fn.accordeon = function (action) {
      return methods[action]
        ? methods[action].apply(this, Array.prototype.slice.call(arguments, 1))
        : "object" != typeof action && action
        ? (console.info("Action " + action + "not found this plugin"), this)
        ...
        ptBackToTop.on("click", function (e) {
          ...
          $window.scroll(function () {
            $window.scrollTop() > 500
              ? ptBackToTop.stop((!0).false).addClass("pt-show")
              : ptBackToTop.stop((!0).false).removeClass("pt-show");
          });
      })();
  })(jQuery),
  (function ($) {
  ...
  (function ($) {
    ...
    nav.find("> ul > li").each(function () {
      ...
      (cur_url =
        window.location.href.split("#")[0].split("/").pop() || "index.html"),
  ...
  (function ($) {
    ...
    function closeDropdown() {
      $("#tt-header .js-dropdown-cart").each(function () {
        $(this).removeClass("active"),
          setTimeout(function () {
            $("#tt-header .js-dropdown-cart")
              .find(".tt-obj__dropdown")
              .children()
              .remove();
          }, 200);
      });
    ...
    $("body").on(
      "click touchstart",
      ".js-dropdown-cart .tt-obj__btn",
      function (e) {
        if (
          (e.preventDefault(),
          $(this).closest(".js-dropdown-cart").hasClass("active"))
        )
          return closeDropdown(), !1;
        $.ajax({
      ...
      $("body").on(
        "click touchstart",
        ".js-dropdown-cart .tt-obj__dropdown-close",
        function (e) {
          closeDropdown();
        }
      ),
  ...
  (function ($) {
    ...
    var valueFilter;
    (valueFilter = filterNav.find(".active a").attr("href")),
      filterLayout.find("." + valueFilter).addClass("show");
    $("body").on(
      "click touchstart",
      "#filter-nav .gallery-navitem",
      function (e) {
        if ((e.preventDefault(), $(this).closest("li").hasClass("active")))
          return !1;
        $(this)
          .closest("li")
          .addClass("active")
    ...
    $("#tt-pageContent .tt-slideinfo")
      ...
      $("body").on(
        ...
        function (e) {
          var obj = $(this);
          return (
            $(this).closest(".tt-slideinfo").hasClass("open-info")
  ...
  (function ($) {
    ...
    $("#modalMakeAppointment .js_datepicker-1")
      .datepicker({ language: "en" })
      .data("datepicker"),
      $("#orderform .datepicker-1")
        .datepicker({ language: "en" })
        .data("datepicker");
  })(jQuery),
  (function ($) {
  ...
  (function ($) {
    function calcHeight() {
      if ((window.innerWidth || $(window).width()) <= 786)
        return (
        ...
        mainSlider.on("init", function (e, slick) {
          ...
          mainSlider.on(
            ...
            function (e, slick, currentSlide, nextSlide) {
              doAnimations(
                $('div.slide[data-slick-index="' + nextSlide + '"]').find(
                  "[data-animation]"
                )
              );
            }
          ...
          mainSlider.slick({
            ...
            responsive: [
              ...
              { breakpoint: 1025, settings: { dots: !1, arrows: !1 } },
            ],
          });
      })();
  })(jQuery);
  ...
  window.onscroll = function () {
    ...
    headerOffset.top
      ? (stickyHeader.classList.add("fixed"),
        $html && $html.classList.add("fixed"))
      : (stickyHeader.classList.remove("fixed"),
        $html && $html.classList.remove("fixed"));
  };
}),
  (function ($) {
